...
var $author$project$SpaceAge$earthSecondsPerYear = 31557600.0;
var $author$project$SpaceAge$planetOrbitalPeriod = function (planet) {
	switch (planet.$) {
		case 'Mercury':
			return 0.2408467;
		case 'Venus':
...
var $author$project$SpaceAge$ageOn = F2(
	function (planet, secondsAlive) {
		return secondsAlive / ($author$project$SpaceAge$earthSecondsPerYear * $author$project$SpaceAge$planetOrbitalPeriod(planet));
	});
...
var $author$project$Test$Generated$Main357154667$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/space-age/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 157465937704063
	},
...
_Platform_export({'Test':{'Generated':{'Main357154667':{'init':$author$project$Test$Generated$Main357154667$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-9742.sock";
