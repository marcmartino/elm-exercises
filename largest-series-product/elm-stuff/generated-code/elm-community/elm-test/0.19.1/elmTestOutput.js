...
var $author$project$LargestSeriesProduct$genGroupings = F2(
	function (l, xList) {
		if (_Utils_cmp(
			$elm$core$List$length(xList),
			l) < 0) {
			return _List_Nil;
		} else {
			if (!xList.b) {
				...
				return A2(
					...
					A2(
						...
						l,
						A2($elm$core$List$cons, x, xs)),
					A2($author$project$LargestSeriesProduct$genGroupings, l, xs));
			}
		}
	});
...
var $author$project$LargestSeriesProduct$findLargestProduct = function (length) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$LargestSeriesProduct$genGroupings(length),
		A2(
			$elm$core$Basics$composeR,
			$elm$core$List$map(
...
var $author$project$LargestSeriesProduct$isNumerical = function () {
	var regex = A2(
		$elm$core$Maybe$withDefault,
...
var $author$project$LargestSeriesProduct$isValid = F2(
	function (len, series) {
		return ((_Utils_cmp(
			len,
			$elm$core$String$length(series)) < 1) && ((len >= 0) && $author$project$LargestSeriesProduct$isNumerical(series))) ? $elm$core$Maybe$Just(_Utils_Tuple0) : $elm$core$Maybe$Nothing;
	});
var $author$project$LargestSeriesProduct$toNumList = A2(
	$elm$core$Basics$composeR,
...
var $author$project$LargestSeriesProduct$largestProduct = F2(
	function (length, series) {
		return A2(
			$elm$core$Maybe$map,
			$author$project$LargestSeriesProduct$findLargestProduct(length),
			A2(
				$elm$core$Maybe$map,
				$elm$core$Basics$always(
					$author$project$LargestSeriesProduct$toNumList(series)),
				A2($author$project$LargestSeriesProduct$isValid, length, series)));
	});
...
var $author$project$Test$Generated$Main723662324$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/largest-series-product/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 332022643043949
	},
...
_Platform_export({'Test':{'Generated':{'Main723662324':{'init':$author$project$Test$Generated$Main723662324$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-16779.sock";
