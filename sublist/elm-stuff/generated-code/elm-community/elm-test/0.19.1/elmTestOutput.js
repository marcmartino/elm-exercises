...
var $author$project$Sublist$Equal = {$: 'Equal'};
var $author$project$Sublist$Sublist = {$: 'Sublist'};
var $author$project$Sublist$Superlist = {$: 'Superlist'};
var $author$project$Sublist$Unequal = {$: 'Unequal'};
...
var $author$project$Sublist$isPrefixOf = F3(
	function (prevTrue, xList, yList) {
		isPrefixOf:
		while (true) {
			var _v0 = _Utils_Tuple3(prevTrue, xList, yList);
			_v0$0:
			while (true) {
				if (!_v0.b.b) {
					if (!_v0.a) {
					...
					if (!_v0.c.b) {
						...
						if (!_v0.a) {
							...
							var y = _v2.a;
							var ys = _v2.b;
							var $temp$prevTrue = _Utils_eq(x, y),
								$temp$xList = xs,
								$temp$yList = ys;
							prevTrue = $temp$prevTrue;
							xList = $temp$xList;
							yList = $temp$yList;
							continue isPrefixOf;
						}
...
var $author$project$Sublist$isSublistRec = F3(
	function (prevTrue, xList, yList) {
		isSublistRec:
		while (true) {
			var _v0 = _Utils_Tuple3(prevTrue, xList, yList);
			...
			while (true) {
				if (!_v0.c.b) {
					...
					if (_v0.a) {
						...
						var y = _v1.a;
						var ys = _v1.b;
						var $temp$prevTrue = A3(
							$author$project$Sublist$isPrefixOf,
							true,
							xs,
							A2($elm$core$List$cons, y, ys)),
							$temp$xList = xs,
...
var $author$project$Sublist$isSublist = $author$project$Sublist$isSublistRec(false);
var $author$project$Sublist$sublist = F2(
	function (xs, ys) {
		var sublistChecks = _Utils_Tuple2(
			A2($author$project$Sublist$isSublist, xs, ys),
			A2($author$project$Sublist$isSublist, ys, xs));
		if (sublistChecks.a) {
			if (sublistChecks.b) {
				return $author$project$Sublist$Equal;
			} else {
				return $author$project$Sublist$Sublist;
			}
		} else {
			if (sublistChecks.b) {
				return $author$project$Sublist$Superlist;
			} else {
				return $author$project$Sublist$Unequal;
			}
		}
	});
		...
		[
			...
			function (_v0) {
				return A2(
					...
					$author$project$Sublist$Equal,
					A2($author$project$Sublist$sublist, _List_Nil, _List_Nil));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$author$project$Sublist$Sublist,
					A2(
						$author$project$Sublist$sublist,
						_List_Nil,
						_List_fromArray(
			...
			function (_v2) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$author$project$Sublist$Superlist,
					A2(
						$author$project$Sublist$sublist,
						_List_fromArray(
							[1, 2]),
			...
			function (_v3) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$author$project$Sublist$Unequal,
					A2(
						$author$project$Sublist$sublist,
						_List_fromArray(
							[1]),
			...
			function (_v10) {
				return A2(
					...
					A2(
						$author$project$Sublist$sublist,
						A2($elm$core$List$range, 10, 5001),
						A2($elm$core$List$range, 1, 5000)));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'superlist at start',
...
var $author$project$Test$Generated$Main2395119428$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/sublist/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 158942539363341
	},
...
_Platform_export({'Test':{'Generated':{'Main2395119428':{'init':$author$project$Test$Generated$Main2395119428$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-18527.sock";
