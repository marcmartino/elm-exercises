...
var $author$project$DifferenceOfSquares$sumOfSquares = function (n) {
	return A3(
		...
		F2(
			function (x, a) {
				return a + A2($elm$core$Basics$pow, x, 2);
			}),
		1,
		A2($elm$core$List$range, 2, n));
};
...
var $author$project$Test$Generated$Main264576257$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/difference-of-squares/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 290712150041126
	},
...
_Platform_export({'Test':{'Generated':{'Main264576257':{'init':$author$project$Test$Generated$Main264576257$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-16446.sock";
