...
var $author$project$Transpose$charAccum = F2(
	function (_char, str) {
		if (_char.$ === 'Just') {
			var c = _char.a;
			return _Utils_ap(
...
var $author$project$Transpose$trimEndSpaces = function (str) {
	var _v0 = $elm$core$String$trimRight(str);
	if (_v0 === '') {
		return str;
	} else {
		var trimmed = _v0;
...
var $author$project$Transpose$transposedList = function (list) {
	var rest = A2(
		$elm$core$List$map,
		A2(
			$elm$core$Basics$composeL,
			...
			$elm$core$List$tail),
		list);
	var restCount = $elm$core$List$sum(
		A2($elm$core$List$map, $elm$core$List$length, rest));
	var headString = $author$project$Transpose$trimEndSpaces(
		A3(
			$elm$core$List$foldl,
			$author$project$Transpose$charAccum,
			'',
			A2($elm$core$List$map, $elm$core$List$head, list)));
	var _v0 = _Utils_Tuple2(restCount, headString);
	if (!_v0.a) {
		if (_v0.b === '') {
			return _List_Nil;
		} else {
		...
		return A2(
			$elm$core$List$cons,
			headString,
			$author$project$Transpose$transposedList(rest));
	}
};
var $author$project$Transpose$transpose = A2(
	$elm$core$Basics$composeL,
	$author$project$Transpose$transposedList,
		...
		[
			...
			function (_v0) {
				return A2(
					...
					_List_Nil,
					$author$project$Transpose$transpose(_List_Nil));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v1) {
				return A2(
					...
					_List_fromArray(
						['A', '1']),
					$author$project$Transpose$transpose(
						_List_fromArray(
							['A1'])));
			}),
			A2(
			...
			function (_v7) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_List_fromArray(
						['TAAA', 'h   ', 'elll', ' ooi', 'lnnn', 'ogge', 'n e.', 'glr', 'ei ', 'snl', 'tei', ' .n', 'l e', 'i .', 'n', 'e', '.']),
					$author$project$Transpose$transpose(
						_List_fromArray(
...
var $author$project$Test$Generated$Main1176904777$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/transpose/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 190262611590591
	},
...
_Platform_export({'Test':{'Generated':{'Main1176904777':{'init':$author$project$Test$Generated$Main1176904777$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-15487.sock";
