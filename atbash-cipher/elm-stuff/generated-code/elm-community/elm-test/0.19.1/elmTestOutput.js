...
var $author$project$AtbashCipher$invertAlpha = function (l) {
	var flippedChar = A2(
		$elm$core$Basics$composeR,
		...
		A2(
			...
			A2(
				$elm$core$Basics$composeR,
				$elm$core$Basics$add(-122),
				A2(
					$elm$core$Basics$composeR,
					$elm$core$Basics$abs,
					A2(
						$elm$core$Basics$composeR,
						$elm$core$Basics$add(97),
						$elm$core$Char$fromCode)))));
	return $elm$core$Char$isAlpha(l) ? flippedChar(l) : l;
};
...
var $author$project$AtbashCipher$sanitizeEncodedText = function () {
	var regex = A2(
		$elm$core$Maybe$withDefault,
...
var $author$project$AtbashCipher$decode = A2(
	$elm$core$Basics$composeR,
	$author$project$AtbashCipher$sanitizeEncodedText,
	A2(
		$elm$core$Basics$composeR,
		...
		A2(
			...
			A2(
				$elm$core$Basics$composeR,
				$elm$core$List$map($author$project$AtbashCipher$invertAlpha),
				$elm$core$String$fromList))));
var $elm$core$Tuple$second = function (_v0) {
	var y = _v0.b;
	return y;
};
var $author$project$AtbashCipher$splitList = F2(
	function (count, list) {
		var _v0 = _Utils_Tuple2(count, list);
		_v0$0:
		while (true) {
			if (!_v0.b.b) {
				if (!_v0.a) {
				...
				if (!_v0.a) {
					...
					var x = _v1.a;
					var xs = _v1.b;
					var furtherSplit = A2($author$project$AtbashCipher$splitList, n - 1, xs);
					return _Utils_Tuple2(
						A2($elm$core$List$cons, x, furtherSplit.a),
						furtherSplit.b);
				}
			}
		}
...
var $author$project$AtbashCipher$groupList = F2(
	function (n, list) {
		var _v0 = A2($author$project$AtbashCipher$splitList, n, list);
		if (!_v0.b.b) {
			var group = _v0.a;
			return _List_fromArray(
				[group]);
			...
			return A2(
				$elm$core$List$cons,
				group,
				A2($author$project$AtbashCipher$groupList, n, rest));
		}
	});
var $author$project$AtbashCipher$sanitizeUnencodedText = function () {
	var regex = A2(
		$elm$core$Maybe$withDefault,
		$elm$regex$Regex$never,
		$elm$regex$Regex$fromString('[^\\d\\w]'));
...
var $author$project$AtbashCipher$encode = A2(
	$elm$core$Basics$composeR,
	$author$project$AtbashCipher$sanitizeUnencodedText,
	A2(
		$elm$core$Basics$composeR,
		$elm$core$String$trim,
		A2(
			...
			A2(
				...
				A2(
					$elm$core$Basics$composeR,
					$author$project$AtbashCipher$groupList(5),
					A2(
						$elm$core$Basics$composeR,
		...
		[
			...
			function (_v0) {
				return A2(
					...
					'ml',
					$author$project$AtbashCipher$encode('no'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'encode yes',
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'bvh',
					$author$project$AtbashCipher$encode('yes'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'encode OMG',
			function (_v2) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'lnt',
					$author$project$AtbashCipher$encode('OMG'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'encode O M G',
			function (_v3) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'lnt',
					$author$project$AtbashCipher$encode('O M G'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'encode long word',
			function (_v4) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'nrmwy oldrm tob',
					$author$project$AtbashCipher$encode('mindblowingly'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'encode numbers',
			function (_v5) {
				return A2(
					...
					$author$project$AtbashCipher$encode('Testing, 1 2 3, testing.'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'encode sentence',
			function (_v6) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'gifgs rhurx grlm',
					$author$project$AtbashCipher$encode('Truth is fiction.'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'encode all things',
			function (_v7) {
				return A2(
					...
					$author$project$AtbashCipher$encode('The quick brown fox jumps over the lazy dog.'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'decode word',
			function (_v8) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'exercism',
					$author$project$AtbashCipher$decode('vcvix rhn'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'decode sentence',
			function (_v9) {
				return A2(
					...
					$author$project$AtbashCipher$decode('zmlyh gzxov rhlug vmzhg vkkrm thglm v'));
			})
		]));
var $author$project$Test$Generated$Main1375910099$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/atbash-cipher/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 213699298263640
	},
...
_Platform_export({'Test':{'Generated':{'Main1375910099':{'init':$author$project$Test$Generated$Main1375910099$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-7180.sock";
