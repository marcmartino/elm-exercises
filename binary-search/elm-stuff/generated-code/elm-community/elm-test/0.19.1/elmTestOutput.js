...
var $author$project$BinarySearch$EQ = {$: 'EQ'};
var $author$project$BinarySearch$GT = {$: 'GT'};
var $author$project$BinarySearch$LT = {$: 'LT'};
var $author$project$BinarySearch$NEQ = {$: 'NEQ'};
var $author$project$BinarySearch$elemComparison = F2(
	function (baseline, val) {
		return _Utils_eq(baseline, val) ? $author$project$BinarySearch$EQ : ((_Utils_cmp(baseline, val) < 0) ? $author$project$BinarySearch$LT : ((_Utils_cmp(baseline, val) > 0) ? $author$project$BinarySearch$GT : $author$project$BinarySearch$NEQ));
	});
...
var $author$project$BinarySearch$find = F2(
	function (target, xs) {
		find:
		while (true) {
			if ($elm$core$Array$isEmpty(xs)) {
				return $elm$core$Maybe$Nothing;
			} else {
				var middleI = $elm$core$Basics$floor(
					0.5 * $elm$core$Array$length(xs));
				var _v0 = A2(
					$elm$core$Maybe$map,
					$author$project$BinarySearch$elemComparison(target),
					A2($elm$core$Array$get, middleI, xs));
				_v0$3:
				while (true) {
					if (_v0.$ === 'Just') {
						switch (_v0.a.$) {
							case 'EQ':
								var _v1 = _v0.a;
								return $elm$core$Maybe$Just(middleI);
							case 'GT':
								var _v2 = _v0.a;
								return A2(
									$elm$core$Maybe$map,
									...
									A2(
										...
										A3(
											...
											middleI + 1,
											1 + $elm$core$Array$length(xs),
											xs)));
							case 'LT':
								var _v3 = _v0.a;
								var $temp$target = target,
									$temp$xs = A3($elm$core$Array$slice, 0, middleI, xs);
								target = $temp$target;
								xs = $temp$xs;
								continue find;
							default:
...
var $author$project$Test$Generated$Main1002252808$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/binary-search/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 289134751514515
	},
...
_Platform_export({'Test':{'Generated':{'Main1002252808':{'init':$author$project$Test$Generated$Main1002252808$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-23774.sock";
