...
var $author$project$GradeSchool$addStudent = F3(
	function (grade, student, school) {
		...
		return A3(
			...
			grade,
			$elm$core$List$sort(
				A2($elm$core$List$cons, student, existingStudents)),
			school);
	});
var $author$project$GradeSchool$allStudents = $elm$core$Dict$toList;
...
var $author$project$GradeSchool$studentsInGrade = function (grade) {
	return A2(
		$elm$core$Basics$composeR,
		$elm$core$Dict$get(grade),
...
var $author$project$Test$Generated$Main662060041$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/grade-school/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 153412714659187
	},
...
_Platform_export({'Test':{'Generated':{'Main662060041':{'init':$author$project$Test$Generated$Main662060041$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-25062.sock";
