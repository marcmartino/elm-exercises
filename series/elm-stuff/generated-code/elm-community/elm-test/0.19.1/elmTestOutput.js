...
var $author$project$Series$getSlices = F2(
	function (size, series) {
		if (_Utils_cmp(
			size,
			$elm$core$List$length(series)) > 0) {
			return _List_Nil;
		} else {
			if (!series.b) {
				return _List_Nil;
			} else {
				var seriesRest = series.b;
				return A2(
					$elm$core$List$cons,
					A2($elm$core$List$take, size, series),
					A2($author$project$Series$getSlices, size, seriesRest));
			}
		}
	});
...
var $author$project$Series$seriesToList = A2(
	$elm$core$Basics$composeR,
...
var $author$project$Series$emptySeries = function (series) {
	return (!(!$elm$core$String$length(series))) ? $elm$core$Result$Ok(series) : $elm$core$Result$Err('series cannot be empty');
};
var $author$project$Series$sliceLengthLTSeries = F2(
	function (str, size) {
		return (_Utils_cmp(
			$elm$core$String$length(str),
			size) > -1) ? $elm$core$Result$Ok(size) : $elm$core$Result$Err('slice length cannot be greater than series length');
	});
var $author$project$Series$sliceLengthNonZero = function (size) {
	return (!(!size)) ? $elm$core$Result$Ok(size) : $elm$core$Result$Err('slice length cannot be zero');
};
var $author$project$Series$sliceLengthPositive = function (size) {
	return (size >= 0) ? $elm$core$Result$Ok(size) : $elm$core$Result$Err('slice length cannot be negative');
};
var $author$project$Series$validation = F2(
	function (size, input) {
		return A2(
			$elm$core$Result$map,
			...
			A2(
				...
				$author$project$Series$sliceLengthNonZero,
				A2(
					$elm$core$Result$andThen,
					$author$project$Series$sliceLengthPositive,
					A2(
						$elm$core$Result$andThen,
						$author$project$Series$sliceLengthLTSeries(input),
						A2(
							$elm$core$Result$map,
							$elm$core$Basics$always(size),
							$author$project$Series$emptySeries(input))))));
	});
var $author$project$Series$slices = F2(
	function (size, input) {
		return A2(
			$elm$core$Result$map,
			$author$project$Series$getSlices(size),
			A2(
				$elm$core$Result$map,
				$elm$core$Basics$always(
					$author$project$Series$seriesToList(input)),
				A2($author$project$Series$validation, size, input)));
	});
		...
		[
			...
			function (_v0) {
				return A2(
					...
					A2($author$project$Series$slices, 1, '1'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v1) {
				return A2(
					...
					A2($author$project$Series$slices, 1, '12'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'slices of two',
			function (_v2) {
				return A2(
					...
					A2($author$project$Series$slices, 2, '35'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v3) {
				return A2(
					...
					A2($author$project$Series$slices, 2, '9142'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v4) {
				return A2(
					...
					A2($author$project$Series$slices, 3, '777777'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v5) {
				return A2(
					...
					A2($author$project$Series$slices, 5, '918493904243'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v6) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Err('slice length cannot be greater than series length'),
					A2($author$project$Series$slices, 6, '12345'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v7) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Err('slice length cannot be zero'),
					A2($author$project$Series$slices, 0, '12345'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v8) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Err('slice length cannot be negative'),
					A2($author$project$Series$slices, -1, '123'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v9) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Err('series cannot be empty'),
					A2($author$project$Series$slices, 1, ''));
			})
		]));
var $author$project$Test$Generated$Main178240704$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/series/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 232401912668860
	},
...
_Platform_export({'Test':{'Generated':{'Main178240704':{'init':$author$project$Test$Generated$Main178240704$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-1224.sock";
