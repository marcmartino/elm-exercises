...
var $author$project$Say$Negative = {$: 'Negative'};
var $author$project$Say$TooLarge = {$: 'TooLarge'};
...
var $author$project$Say$digitGroupName = function (num) {
	switch (num) {
		case 0:
			return $elm$core$Maybe$Just('');
		case 1:
			return $elm$core$Maybe$Just('thousand');
		case 2:
			return $elm$core$Maybe$Just('million');
		case 3:
			return $elm$core$Maybe$Just('billion');
		case 4:
			return $elm$core$Maybe$Just('trillion');
		case 5:
			return $elm$core$Maybe$Just('quadrillion');
		case 6:
			return $elm$core$Maybe$Just('quintrillion');
		case 7:
			return $elm$core$Maybe$Just('sentillion');
		case 8:
			return $elm$core$Maybe$Just('septillion');
		default:
			return $elm$core$Maybe$Nothing;
	}
};
var $author$project$Say$addOrdersOfMagnitude = function () {
	var addMagnitude = function (_v2) {
		var i = _v2.a;
		var words = _v2.b;
		return words + (' ' + A2(
			$elm$core$Maybe$withDefault,
			'',
			$author$project$Say$digitGroupName(i)));
	};
	return A2(
		$elm$core$Basics$composeR,
		$elm$core$List$reverse,
		A2(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$Basics$composeR,
						$elm$core$List$map(addMagnitude),
						$elm$core$List$reverse)))));
}();
var $elm$core$String$length = _String_length;
var $author$project$Say$defaultToZero = function (num) {
	return (!$elm$core$String$length(num)) ? 'zero' : num;
};
var $author$project$Say$filterNothings = function (items) {
	filterNothings:
	while (true) {
		if (items.b) {
			if (items.a.$ === 'Just') {
				...
				return A2(
					$elm$core$List$cons,
					x,
					$author$project$Say$filterNothings(xs));
			} else {
				var _v1 = items.a;
				var xs = items.b;
				var $temp$items = xs;
				items = $temp$items;
				continue filterNothings;
			}
		} else {
			return _List_Nil;
		}
...
var $author$project$Say$singleDigitName = function (num) {
	switch (num) {
		case 1:
		...
		case 3:
			return $elm$core$Maybe$Just('three');
		case 4:
			return $elm$core$Maybe$Just('four');
		case 5:
			return $elm$core$Maybe$Just('five');
		case 6:
			return $elm$core$Maybe$Just('six');
		case 7:
			return $elm$core$Maybe$Just('seven');
		case 8:
			return $elm$core$Maybe$Just('eight');
		case 9:
			return $elm$core$Maybe$Just('nine');
		default:
			return $elm$core$Maybe$Nothing;
	}
};
var $author$project$Say$getHundredsWords = function (digit) {
	if (!digit) {
		return _List_Nil;
	} else {
		return _List_fromArray(
			[
				$author$project$Say$singleDigitName(digit),
				$elm$core$Maybe$Just('hundred')
			]);
	}
};
var $author$project$Say$getSingleDigitName = function (digit) {
	return _List_fromArray(
		[
			$author$project$Say$singleDigitName(digit)
		]);
};
var $author$project$Say$hyphenate = F2(
	function (a, b) {
		var _v0 = _Utils_Tuple2(a, b);
		if ((_v0.a.$ === 'Just') && (_v0.b.$ === 'Just')) {
			var first = _v0.a.a;
			var second = _v0.b.a;
			return $elm$core$Maybe$Just(first + ('-' + second));
		} else {
			return $elm$core$Maybe$Nothing;
		}
	});
var $author$project$Say$teenDigitsName = function (num) {
	switch (num) {
		case 10:
			return $elm$core$Maybe$Just('ten');
		case 11:
			return $elm$core$Maybe$Just('eleven');
		case 12:
			return $elm$core$Maybe$Just('twelve');
		case 13:
			return $elm$core$Maybe$Just('thirteen');
		case 14:
			return $elm$core$Maybe$Just('fourteen');
		case 15:
			return $elm$core$Maybe$Just('fifteen');
		case 16:
			return $elm$core$Maybe$Just('sixteen');
		case 17:
			return $elm$core$Maybe$Just('seventeen');
		case 18:
			return $elm$core$Maybe$Just('eighteen');
		case 19:
			return $elm$core$Maybe$Just('nineteen');
		default:
			return $elm$core$Maybe$Nothing;
	}
};
var $author$project$Say$tensName = function (num) {
	switch (num) {
		case 1:
			return $elm$core$Maybe$Just('ten');
		case 2:
			return $elm$core$Maybe$Just('twenty');
		case 3:
			return $elm$core$Maybe$Just('thirty');
		case 4:
			return $elm$core$Maybe$Just('forty');
		case 5:
			return $elm$core$Maybe$Just('fifty');
		case 6:
			return $elm$core$Maybe$Just('sixty');
		case 7:
			return $elm$core$Maybe$Just('seventy');
		case 8:
			return $elm$core$Maybe$Just('eighty');
		case 9:
			return $elm$core$Maybe$Just('nintey');
		default:
			return $elm$core$Maybe$Nothing;
	}
};
var $author$project$Say$getTensAndOnesWords = F2(
	function (tens, ones) {
		var _v0 = _Utils_Tuple2(tens, ones);
		switch (_v0.a) {
			case 0:
				if (!_v0.b) {
					return _List_Nil;
				} else {
					return $author$project$Say$getSingleDigitName(ones);
				}
			case 1:
				return _List_fromArray(
					[
						$author$project$Say$teenDigitsName((tens * 10) + ones)
					]);
			default:
				if (!_v0.b) {
					return _List_fromArray(
						[
							$author$project$Say$tensName(tens)
						]);
				} else {
					return _List_fromArray(
						[
							A2(
							$author$project$Say$hyphenate,
							$author$project$Say$tensName(tens),
							$elm$core$Maybe$Just(
								A2(
									$elm$core$String$join,
									' ',
									$author$project$Say$filterNothings(
										$author$project$Say$getSingleDigitName(ones)))))
						]);
				}
		}
	});
var $author$project$Say$digitsToSpokenNumber = function (_v0) {
	var hundreds = _v0.a;
	var tens = _v0.b;
	var ones = _v0.c;
	var tensText = A2($author$project$Say$getTensAndOnesWords, tens, ones);
	var hundredsText = $author$project$Say$getHundredsWords(hundreds);
	var andText = (($elm$core$List$length(hundredsText) > 0) && ($elm$core$List$length(tensText) > 0)) ? _List_fromArray(
		[
			$elm$core$Maybe$Just('and')
		]) : _List_Nil;
	var text = ((!hundreds) && ((!tens) && (!ones))) ? _List_Nil : $elm$core$List$concat(
		_List_fromArray(
			[hundredsText, andText, tensText]));
	return A2(
		$elm$core$String$join,
		' ',
		$author$project$Say$filterNothings(text));
};
...
var $author$project$Say$groupList = F2(
	function (groupSize, list) {
		if (!list.b) {
			...
			return A2(
				$elm$core$List$cons,
				A2($elm$core$List$take, groupSize, list),
				A2(
					$author$project$Say$groupList,
					groupSize,
					A2($elm$core$List$drop, groupSize, list)));
		}
	});
var $author$project$Say$toIntList = function (num) {
	var negativeMultiplier = (num >= 0) ? 1 : (-1);
	return function (digits) {
		if (digits.b) {
			var d = digits.a;
			var ds = digits.b;
			return A2($elm$core$List$cons, d * negativeMultiplier, ds);
		} else {
			return _List_Nil;
		}
	}(
...
var $author$project$Say$toTriple = function (list) {
	_v0$3:
	while (true) {
		if (list.b) {
			if (!list.b.b) {
				var x = list.a;
				return _Utils_Tuple3(0, 0, x);
			} else {
				if (!list.b.b.b) {
					var x = list.a;
					var _v1 = list.b;
					var y = _v1.a;
					return _Utils_Tuple3(0, x, y);
				} else {
					if (!list.b.b.b.b) {
						var x = list.a;
						var _v2 = list.b;
...
var $author$project$Say$groupOrdersOfMagnitude = A2(
	$elm$core$Basics$composeR,
	$elm$core$Basics$abs,
	A2(
		$elm$core$Basics$composeR,
		$author$project$Say$toIntList,
		A2(
			$elm$core$Basics$composeR,
			$elm$core$List$reverse,
			A2(
				$elm$core$Basics$composeR,
				$author$project$Say$groupList(3),
				A2(
					$elm$core$Basics$composeR,
					...
					A2(
						$elm$core$Basics$composeR,
						$elm$core$List$reverse,
						$elm$core$List$map($author$project$Say$toTriple)))))));
var $author$project$Say$isValidNumber = function (num) {
	return (num < 0) ? $elm$core$Result$Err($author$project$Say$Negative) : ((num >= 1000000000000) ? $elm$core$Result$Err($author$project$Say$TooLarge) : $elm$core$Result$Ok(num));
};
...
var $author$project$Say$negativeName = function (num) {
	return (num < 0) ? 'negative' : '';
};
var $author$project$Say$say = function (num) {
	var appendNegative = $elm$core$List$append(
		_List_fromArray(
			[
				$author$project$Say$negativeName(num)
			]));
	return A2(
		$elm$core$Result$map,
		A2(
			$elm$core$Basics$composeR,
			$author$project$Say$groupOrdersOfMagnitude,
			A2(
				$elm$core$Basics$composeR,
				$elm$core$List$map($author$project$Say$digitsToSpokenNumber),
				A2(
					$elm$core$Basics$composeR,
					$author$project$Say$addOrdersOfMagnitude,
					A2(
						$elm$core$Basics$composeR,
						appendNegative,
						A2(
							$elm$core$Basics$composeR,
							$elm$core$String$join(' '),
							A2($elm$core$Basics$composeR, $elm$core$String$trim, $author$project$Say$defaultToZero)))))),
		$author$project$Say$isValidNumber(num));
};
	...
	_List_fromArray(
		[
			...
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Ok('fourteen'),
					$author$project$Say$say(14));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'twenty',
			function (_v2) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Ok('twenty'),
					$author$project$Say$say(20));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'twenty-two',
			function (_v3) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Ok('twenty-two'),
					$author$project$Say$say(22));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'one hundred',
			function (_v4) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Ok('one hundred'),
					$author$project$Say$say(100));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'one hundred twenty',
			function (_v5) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Ok('one hundred and twenty'),
					$author$project$Say$say(120));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v6) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Ok('one hundred and twenty-three'),
					$author$project$Say$say(123));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'one thousand',
			function (_v7) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Ok('one thousand'),
					$author$project$Say$say(1000));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v8) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Ok('one thousand two hundred and thirty-four'),
					$author$project$Say$say(1234));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'one million',
			function (_v9) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Ok('one million'),
					$author$project$Say$say(1000000));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'one million two',
			function (_v10) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Ok('one million and two'),
					$author$project$Say$say(1000002));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'1002345',
			function (_v11) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Ok('one million two thousand three hundred and forty-five'),
					$author$project$Say$say(1002345));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'one billion',
			function (_v12) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Ok('one billion'),
					$author$project$Say$say(1000000000));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'number too large',
			function (_v13) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Err($author$project$Say$TooLarge),
					$author$project$Say$say(10000000000000000));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'negative number',
			function (_v14) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Err($author$project$Say$Negative),
					$author$project$Say$say(-42));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'zero',
			function (_v15) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Ok('zero'),
					$author$project$Say$say(0));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'987654321123',
			function (_v16) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Ok('nine hundred and eighty-seven billion ' + ('six hundred and fifty-four million ' + ('three hundred and twenty-one thousand ' + 'one hundred and twenty-three'))),
					$author$project$Say$say(987654321123));
			})
		]));
var $author$project$Test$Generated$Main3398959654$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/say/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 381843161364244
	},
...
_Platform_export({'Test':{'Generated':{'Main3398959654':{'init':$author$project$Test$Generated$Main3398959654$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-3917.sock";
