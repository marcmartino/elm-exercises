...
var $author$project$Pangram$onlyEnglishLetters = function () {
	var regex = A2(
		$elm$core$Maybe$withDefault,
...
var $author$project$Pangram$isPangram = A2(
	$elm$core$Basics$composeL,
	A2(
		$elm$core$Basics$composeL,
		A2(
			...
			A2(
				...
				A2(
					$elm$core$Basics$composeL,
					$elm$core$Basics$eq(26),
					$elm$core$Set$size),
				$elm$core$Set$fromList),
			$elm$core$String$toList),
		$elm$core$String$toLower),
	$author$project$Pangram$onlyEnglishLetters);
...
var $author$project$Test$Generated$Main2427678709$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/pangram/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 234480190178159
	},
...
_Platform_export({'Test':{'Generated':{'Main2427678709':{'init':$author$project$Test$Generated$Main2427678709$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-29245.sock";
