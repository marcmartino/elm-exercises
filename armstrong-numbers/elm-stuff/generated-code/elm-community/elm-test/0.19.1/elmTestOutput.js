...
var $author$project$ArmstrongNumbers$charToNum = A2(
	$elm$core$Basics$composeR,
...
var $author$project$ArmstrongNumbers$digitList = A2(
	$elm$core$Basics$composeR,
	$elm$core$String$fromInt,
	A2(
		$elm$core$Basics$composeR,
		$elm$core$String$toList,
		$elm$core$List$map($author$project$ArmstrongNumbers$charToNum)));
var $elm$core$Basics$pow = _Basics_pow;
var $elm$core$List$sum = function (numbers) {
	return A3($elm$core$List$foldl, $elm$core$Basics$add, 0, numbers);
};
var $author$project$ArmstrongNumbers$isArmstrongNumber = function (num) {
	var numList = $author$project$ArmstrongNumbers$digitList(num);
	return _Utils_eq(
		num,
		$elm$core$List$sum(
			A2(
		...
		[
			...
			function (_v0) {
				return A2(
					...
					true,
					$author$project$ArmstrongNumbers$isArmstrongNumber(0));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					true,
					$author$project$ArmstrongNumbers$isArmstrongNumber(5));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v2) {
				return A2(
					$elm_explorations$test$Expect$equal,
					false,
					$author$project$ArmstrongNumbers$isArmstrongNumber(10));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v3) {
				return A2(
					$elm_explorations$test$Expect$equal,
					true,
					$author$project$ArmstrongNumbers$isArmstrongNumber(153));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v4) {
				return A2(
					$elm_explorations$test$Expect$equal,
					false,
					$author$project$ArmstrongNumbers$isArmstrongNumber(100));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v5) {
				return A2(
					$elm_explorations$test$Expect$equal,
					true,
					$author$project$ArmstrongNumbers$isArmstrongNumber(9474));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v6) {
				return A2(
					$elm_explorations$test$Expect$equal,
					false,
					$author$project$ArmstrongNumbers$isArmstrongNumber(9475));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v7) {
				return A2(
					$elm_explorations$test$Expect$equal,
					true,
					$author$project$ArmstrongNumbers$isArmstrongNumber(9926315));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v8) {
				return A2(
					$elm_explorations$test$Expect$equal,
					false,
					$author$project$ArmstrongNumbers$isArmstrongNumber(9926314));
			})
		]));
var $author$project$Test$Generated$Main1634988484$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/armstrong-numbers/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 245926676680199
	},
...
_Platform_export({'Test':{'Generated':{'Main1634988484':{'init':$author$project$Test$Generated$Main1634988484$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-7123.sock";
