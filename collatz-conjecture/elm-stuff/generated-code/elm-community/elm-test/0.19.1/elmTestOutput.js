...
var $author$project$CollatzConjecture$collatzStepCount = function (n) {
	return (n === 1) ? 0 : ((!A2($elm$core$Basics$modBy, 2, n)) ? (1 + $author$project$CollatzConjecture$collatzStepCount((n / 2) | 0)) : (1 + $author$project$CollatzConjecture$collatzStepCount((3 * n) + 1)));
};
...
var $author$project$CollatzConjecture$validNumber = function (x) {
	return (x > 0) ? $elm$core$Result$Ok(x) : $elm$core$Result$Err('Only positive numbers are allowed');
};
var $author$project$CollatzConjecture$collatz = A2(
	$elm$core$Basics$composeR,
	$author$project$CollatzConjecture$validNumber,
	$elm$core$Result$map($author$project$CollatzConjecture$collatzStepCount));
...
var $author$project$Test$Generated$Main16097395$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/collatz-conjecture/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 152501939992160
	},
...
_Platform_export({'Test':{'Generated':{'Main16097395':{'init':$author$project$Test$Generated$Main16097395$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-10713.sock";
