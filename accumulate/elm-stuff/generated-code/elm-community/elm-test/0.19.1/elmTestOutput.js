...
var $author$project$Accumulate$tailAccum = F3(
	function (acc, fn, input) {
		tailAccum:
		while (true) {
			if (!input.b) {
				return acc;
...
var $author$project$Accumulate$accumulate = function (func) {
	return A2(
		$elm$core$Basics$composeL,
		A2($author$project$Accumulate$tailAccum, _List_Nil, func),
		$elm$core$List$reverse);
};
...
var $author$project$Test$Generated$Main2619172649$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/accumulate/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 235003839065273
	},
...
_Platform_export({'Test':{'Generated':{'Main2619172649':{'init':$author$project$Test$Generated$Main2619172649$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-28927.sock";
