...
var $author$project$WordCount$sanitizeInput = function () {
	var whiteSpaceCharsRegex = A2(
		$elm$core$Maybe$withDefault,
		$elm$regex$Regex$never,
		$elm$regex$Regex$fromString('(\\s{2,}|\\s)'));
	var specialCharsRegex = A2(
		$elm$core$Maybe$withDefault,
		$elm$regex$Regex$never,
		$elm$regex$Regex$fromString('([^\\s\\w\']|\'\\s|\\s\'|\'$)'));
	return A2(
		$elm$core$Basics$composeR,
		A2(
...
var $author$project$WordCount$toFrequencyCount = F2(
	function (prevFrequencies, words) {
		toFrequencyCount:
		while (true) {
			if (!words.b) {
				return prevFrequencies;
			} else {
				var word = words.a;
				var otherWords = words.b;
				var newFrequency = A2(
					$elm$core$Maybe$withDefault,
					0,
					A2($elm$core$Dict$get, word, prevFrequencies)) + 1;
				var $temp$prevFrequencies = A3($elm$core$Dict$insert, word, newFrequency, prevFrequencies),
					$temp$words = otherWords;
				prevFrequencies = $temp$prevFrequencies;
				words = $temp$words;
				continue toFrequencyCount;
			}
		}
	});
var $elm$core$String$toLower = _String_toLower;
var $author$project$WordCount$wordCount = A2(
	$elm$core$Basics$composeR,
	$elm$core$String$toLower,
	A2(
		$elm$core$Basics$composeR,
		$author$project$WordCount$sanitizeInput,
		A2(
			$elm$core$Basics$composeR,
			$elm$core$String$split(' '),
			$author$project$WordCount$toFrequencyCount($elm$core$Dict$empty))));
		...
		[
			...
			function (_v3) {
				return A2(
					...
					_List_fromArray(
						[
							_Utils_Tuple2('one', 1),
							_Utils_Tuple2('three', 1),
							_Utils_Tuple2('two', 1)
						]),
					$elm$core$Dict$toList(
						$author$project$WordCount$wordCount('one,two,three')));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v4) {
				return A2(
					...
					$elm$core$Dict$toList(
						$author$project$WordCount$wordCount('one,\ntwo,\nthree')));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'ignore punctuation',
			...
			function (_v8) {
				return A2(
					...
					_List_fromArray(
						[
							_Utils_Tuple2('cry', 1),
							_Utils_Tuple2('don\'t', 2),
							_Utils_Tuple2('first', 1),
							_Utils_Tuple2('laugh', 1),
							_Utils_Tuple2('then', 1)
						]),
					$elm$core$Dict$toList(
						$author$project$WordCount$wordCount('First: don\'t laugh. Then: don\'t cry.')));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'with quotations',
			function (_v9) {
				return A2(
					...
					_List_fromArray(
						[
							_Utils_Tuple2('and', 1),
							_Utils_Tuple2('between', 1),
							_Utils_Tuple2('can\'t', 1),
							_Utils_Tuple2('joe', 1),
							_Utils_Tuple2('large', 2),
							_Utils_Tuple2('tell', 1)
						]),
					$elm$core$Dict$toList(
						$author$project$WordCount$wordCount('Joe can\'t tell between \'large\' and large.')));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v10) {
				return A2(
					...
					$elm$core$Dict$toList(
						$author$project$WordCount$wordCount('Joe can\'t tell between app, apple and a.')));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v11) {
				return A2(
					...
					_List_fromArray(
						[
							_Utils_Tuple2('multiple', 1),
							_Utils_Tuple2('whitespaces', 1)
						]),
					$elm$core$Dict$toList(
						$author$project$WordCount$wordCount(' multiple   whitespaces')));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v12) {
				return A2(
					...
					$elm$core$Dict$toList(
						$author$project$WordCount$wordCount(',\n,one,\n ,two \n \'three\'')));
			})
		]));
var $author$project$Test$Generated$Main1271012894$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/word-count/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 188850419090397
	},
...
_Platform_export({'Test':{'Generated':{'Main1271012894':{'init':$author$project$Test$Generated$Main1271012894$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-3822.sock";
