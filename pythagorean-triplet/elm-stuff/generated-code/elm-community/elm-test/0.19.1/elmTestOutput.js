...
var $author$project$PythagoreanTriplet$generateTriplet = F3(
	function (n, x, y) {
		return _Utils_eq(
			A2($elm$core$Basics$pow, x, 2) + A2($elm$core$Basics$pow, y, 2),
			A2($elm$core$Basics$pow, (n - x) - y, 2)) ? _List_fromArray(
			[
				_Utils_Tuple3(x, y, (n - x) - y)
			]) : _List_Nil;
	});
var $author$project$PythagoreanTriplet$mids = F2(
	function (x, y) {
		return A2($elm$core$List$range, y + 1, ((x - y) / 2) | 0);
	});
var $author$project$PythagoreanTriplet$minTriplet = F2(
	function (n, x) {
		return A2(
			$elm$core$List$concatMap,
			A2($author$project$PythagoreanTriplet$generateTriplet, n, x),
			A2($author$project$PythagoreanTriplet$mids, n, x));
	});
var $author$project$PythagoreanTriplet$triplets = function (n) {
	return A2(
		$elm$core$List$concatMap,
		$author$project$PythagoreanTriplet$minTriplet(n),
		A2($elm$core$List$range, 2, (n / 3) | 0));
};
		...
		[
			...
			function (_v0) {
				return A2(
					...
					$author$project$PythagoreanTriplet$triplets(12));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v1) {
				return A2(
					...
					_List_fromArray(
						[
							_Utils_Tuple3(27, 36, 45)
						]),
					$author$project$PythagoreanTriplet$triplets(108));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v2) {
				return A2(
					...
					_List_fromArray(
						[
							_Utils_Tuple3(200, 375, 425)
						]),
					$author$project$PythagoreanTriplet$triplets(1000));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v3) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_List_Nil,
					$author$project$PythagoreanTriplet$triplets(1001));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v4) {
				return A2(
					...
					_List_fromArray(
						[
							_Utils_Tuple3(9, 40, 41),
							_Utils_Tuple3(15, 36, 39)
						]),
					$author$project$PythagoreanTriplet$triplets(90));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v5) {
				return A2(
					...
					_List_fromArray(
						[
							_Utils_Tuple3(40, 399, 401),
							_Utils_Tuple3(56, 390, 394),
							_Utils_Tuple3(105, 360, 375),
							_Utils_Tuple3(120, 350, 370),
							_Utils_Tuple3(140, 336, 364),
							_Utils_Tuple3(168, 315, 357),
							_Utils_Tuple3(210, 280, 350),
							_Utils_Tuple3(240, 252, 348)
						]),
					$author$project$PythagoreanTriplet$triplets(840));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v6) {
				return A2(
					...
					_List_fromArray(
						[
							_Utils_Tuple3(1200, 14375, 14425),
							_Utils_Tuple3(1875, 14000, 14125),
							_Utils_Tuple3(5000, 12000, 13000),
							_Utils_Tuple3(6000, 11250, 12750),
							_Utils_Tuple3(7500, 10000, 12500)
						]),
					$author$project$PythagoreanTriplet$triplets(30000));
			})
		]));
var $author$project$Test$Generated$Main3137196302$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/pythagorean-triplet/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 186052218261969
	},
...
_Platform_export({'Test':{'Generated':{'Main3137196302':{'init':$author$project$Test$Generated$Main3137196302$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-7318.sock";
