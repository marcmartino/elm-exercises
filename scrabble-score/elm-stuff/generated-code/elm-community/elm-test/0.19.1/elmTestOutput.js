...
var $author$project$ScrabbleScore$scoreCategories = _List_fromArray(
	[
		_Utils_Tuple2('A, E, I, O, U, L, N, R, S, T', 1),
		_Utils_Tuple2('D, G', 2),
		_Utils_Tuple2('B, C, M, P', 3),
		_Utils_Tuple2('F, H, V, W, Y', 4),
		_Utils_Tuple2('K', 5),
		_Utils_Tuple2('J, X', 8),
		_Utils_Tuple2('Q, Z', 10)
	]);
...
var $author$project$ScrabbleScore$letterCategories = A2(
	$elm$core$Basics$composeL,
...
var $author$project$ScrabbleScore$scoreLetterGroupToPairs = function (letterGroupScorePair) {
	return A2(
		$elm$core$List$map,
		function (_char) {
			return _Utils_Tuple2(_char, letterGroupScorePair.b);
		},
		$author$project$ScrabbleScore$letterCategories(letterGroupScorePair.a));
};
var $author$project$ScrabbleScore$letterScores = function () {
	var letterPairs = A2($elm$core$List$concatMap, $author$project$ScrabbleScore$scoreLetterGroupToPairs, $author$project$ScrabbleScore$scoreCategories);
	return A3(
		$elm$core$List$foldl,
		F2(
			function (pair, dict) {
				return A3($elm$core$Dict$insert, pair.a, pair.b, dict);
			}),
		$elm$core$Dict$empty,
		letterPairs);
}();
var $author$project$ScrabbleScore$calculateScore = function (letters) {
	if (!letters.b) {
		return 0;
	} else {
		var x = letters.a;
		...
		return A2(
			$elm$core$Maybe$withDefault,
			0,
			A2($elm$core$Dict$get, x, $author$project$ScrabbleScore$letterScores)) + $author$project$ScrabbleScore$calculateScore(xs);
	}
};
var $elm$core$String$toUpper = _String_toUpper;
var $author$project$ScrabbleScore$scoreWord = A2(
	$elm$core$Basics$composeL,
	A2($elm$core$Basics$composeL, $author$project$ScrabbleScore$calculateScore, $elm$core$String$toList),
...
var $author$project$Test$Generated$Main1391196852$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/scrabble-score/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 142298719210331
	},
...
_Platform_export({'Test':{'Generated':{'Main1391196852':{'init':$author$project$Test$Generated$Main1391196852$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-12746.sock";
