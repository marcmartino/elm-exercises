...
var $author$project$RobotSimulator$advance = function (robot) {
	var coords = robot.coordinates;
	var _v0 = robot.coordinates;
	var x = _v0.x;
	var y = _v0.y;
	return _Utils_update(
		robot,
...
var $author$project$RobotSimulator$performAction = function (action) {
	return action;
};
	...
	return _Utils_update(
		robot,
		{
			bearing: function () {
				...
				switch (_v0.$) {
					case 'North':
						return $author$project$RobotSimulator$West;
					case 'East':
						return $author$project$RobotSimulator$North;
					case 'South':
						return $author$project$RobotSimulator$East;
					default:
						return $author$project$RobotSimulator$South;
				}
			}()
		});
};
...
var $author$project$RobotSimulator$toAction = function (x) {
	switch (x.valueOf()) {
		case 'R':
			return $author$project$RobotSimulator$turnRight;
		case 'L':
			return $author$project$RobotSimulator$turnLeft;
		case 'A':
			return $author$project$RobotSimulator$advance;
		default:
			return $author$project$RobotSimulator$advance;
	}
};
var $author$project$RobotSimulator$simulate = F2(
	function (directions, robot) {
		return A3(
			$elm$core$List$foldl,
			$author$project$RobotSimulator$performAction,
			robot,
			A2(
				$elm$core$List$map,
				$author$project$RobotSimulator$toAction,
...
var $author$project$Test$Generated$Main3294781619$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/robot-simulator/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 134721175451148
	},
...
_Platform_export({'Test':{'Generated':{'Main3294781619':{'init':$author$project$Test$Generated$Main3294781619$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-26832.sock";
