...
var $author$project$Etl$collectLetters = F2(
	function (_v0, allLetters) {
		var letter = _v0.a;
		var pointValue = _v0.b;
		return A3($elm$core$Dict$insert, letter, pointValue, allLetters);
	});
var $elm$core$String$toLower = _String_toLower;
var $author$project$Etl$matchLetterToPointValue = function (_v0) {
	var points = _v0.a;
	var letters = _v0.b;
	if (letters.b) {
		var x = letters.a;
		...
		return A2(
			...
			_Utils_Tuple2(
				...
				points),
			$author$project$Etl$matchLetterToPointValue(
				_Utils_Tuple2(points, xs)));
	} else {
		return _List_Nil;
	}
};
var $author$project$Etl$transform = A2(
	...
	A2(
		$elm$core$Basics$composeR,
		$elm$core$List$concatMap($author$project$Etl$matchLetterToPointValue),
		A2($elm$core$List$foldl, $author$project$Etl$collectLetters, $elm$core$Dict$empty)));
...
var $author$project$Test$Generated$Main2476902007$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/etl/tests/Tests.elm']),
		processes: 8,
...
_Platform_export({'Test':{'Generated':{'Main2476902007':{'init':$author$project$Test$Generated$Main2476902007$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-22066.sock";
