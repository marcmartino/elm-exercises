...
var $author$project$Luhn$isJust = function (mb) {
	if (mb.$ === 'Just') {
		return true;
	} else {
		return false;
...
var $author$project$Luhn$boolMaybe = function (b) {
	return b ? $elm$core$Maybe$Just(_Utils_Tuple0) : $elm$core$Maybe$Nothing;
};
...
var $author$project$Luhn$validChars = function (str) {
	var invalidChars = A2(
		$elm$core$Maybe$withDefault,
		$elm$regex$Regex$never,
		$elm$regex$Regex$fromString('[^\\d\\s]'));
	return $author$project$Luhn$boolMaybe(
		!A2($elm$regex$Regex$contains, invalidChars, str));
};
...
var $author$project$Luhn$calculateChecksum = function () {
	var indexMult = A2(
		$elm$core$Basics$composeR,
...
var $author$project$Luhn$replaceRegex = function (regexStr) {
	var regex = A2(
		$elm$core$Maybe$withDefault,
		$elm$regex$Regex$never,
...
var $author$project$Luhn$sequence = function (list) {
	if (!list.b) {
		...
		if (list.a.$ === 'Just') {
			...
			return A2(
				$elm$core$Maybe$map,
				function (rest) {
					return A2($elm$core$List$cons, x, rest);
				},
				$author$project$Luhn$sequence(xs));
		} else {
			var _v1 = list.a;
			return $elm$core$Maybe$Nothing;
		}
...
var $author$project$Luhn$toListOfDigits = A2(
	$elm$core$Basics$composeR,
	$author$project$Luhn$replaceRegex('[^\\d]'),
	A2(
		$elm$core$Basics$composeR,
		...
		A2(
			...
			$author$project$Luhn$sequence)));
var $author$project$Luhn$validChecksum = A2(
	$elm$core$Basics$composeR,
	$author$project$Luhn$toListOfDigits,
	A2(
		$elm$core$Basics$composeR,
		$elm$core$Maybe$map($author$project$Luhn$calculateChecksum),
		$elm$core$Maybe$andThen($author$project$Luhn$boolMaybe)));
var $elm$core$String$length = _String_length;
var $author$project$Luhn$onlyNumbers = $author$project$Luhn$replaceRegex('[^\\d]');
var $author$project$Luhn$validLength = A2(
	$elm$core$Basics$composeR,
	$author$project$Luhn$onlyNumbers,
	A2(
		$elm$core$Basics$composeR,
		...
		A2(
			...
			$author$project$Luhn$boolMaybe)));
var $author$project$Luhn$verify = F2(
	function (validators, x) {
		if (!validators.b) {
			return $elm$core$Maybe$Just(_Utils_Tuple0);
		} else {
			var validator = validators.a;
			var vs = validators.b;
			return A2(
				$elm$core$Maybe$andThen,
				function (_v1) {
					return A2($author$project$Luhn$verify, vs, x);
				},
				validator(x));
		}
	});
var $author$project$Luhn$valid = function () {
	var validators = _List_fromArray(
		[$author$project$Luhn$validLength, $author$project$Luhn$validChars, $author$project$Luhn$validChecksum]);
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Luhn$verify(validators),
		$author$project$Luhn$isJust);
}();
		...
		[
			...
			function (_v0) {
				return A2(
					...
					$author$project$Luhn$validChecksum('059'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'calculating second checksum',
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Just(_Utils_Tuple0),
					$author$project$Luhn$validChecksum('055 444 285'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'calculating third checksum',
			function (_v2) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Just(_Utils_Tuple0),
					$author$project$Luhn$validChecksum('0000 0'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'verifying length of checksum',
			function (_v3) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Just(_Utils_Tuple0),
					$author$project$Luhn$validLength('059'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'verifying length of second checksum',
			function (_v4) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Just(_Utils_Tuple0),
					$author$project$Luhn$validLength('055 444 285'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'verifying length of third checksum',
			function (_v5) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Just(_Utils_Tuple0),
					$author$project$Luhn$validLength('0000 0'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'verifying chars of checksum',
			function (_v6) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Just(_Utils_Tuple0),
					$author$project$Luhn$validChars('059'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'verifying chars of second checksum',
			function (_v7) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Just(_Utils_Tuple0),
					$author$project$Luhn$validChars('055 444 285'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'verifying chars of third checksum',
			function (_v8) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Just(_Utils_Tuple0),
					$author$project$Luhn$validChars('0000 0'));
			}),
			A2(
			$elm_explorations$test$Test$test,
...
var $author$project$Test$Generated$Main3796597061$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/luhn/tests/Tests.elm']),
		processes: 8,
...
_Platform_export({'Test':{'Generated':{'Main3796597061':{'init':$author$project$Test$Generated$Main3796597061$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-15020.sock";
