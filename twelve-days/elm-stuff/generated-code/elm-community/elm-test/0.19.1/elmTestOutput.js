...
var $author$project$TwelveDays$christmasGifts = $elm$core$Array$fromList(
	_List_fromArray(
...
var $author$project$TwelveDays$nthOfArray = F2(
	function (arr, i) {
		return A2(
			$elm$core$Maybe$withDefault,
			'',
...
var $author$project$TwelveDays$christmasGiftByNumber = $author$project$TwelveDays$nthOfArray($author$project$TwelveDays$christmasGifts);
var $author$project$TwelveDays$concatLastGiftAnd = function (gifts) {
	if (!gifts.b) {
		return _List_Nil;
	} else {
		if (!gifts.b.b) {
			...
			if (!gifts.b.b.b) {
				...
				return A2(
					$elm$core$List$cons,
					g,
					$author$project$TwelveDays$concatLastGiftAnd(gs));
			}
		}
	}
};
var $author$project$TwelveDays$daySpellings = $elm$core$Array$fromList(
	_List_fromArray(
		['first', 'second', 'third', 'fourth', 'fifth', 'sixth', 'seventh', 'eighth', 'ninth', 'tenth', 'eleventh', 'twelfth']));
var $author$project$TwelveDays$daySpellingByNumber = $author$project$TwelveDays$nthOfArray($author$project$TwelveDays$daySpellings);
var $elm$core$String$concat = function (strings) {
	return A2($elm$core$String$join, '', strings);
};
var $author$project$TwelveDays$lineLyrics = F2(
	function (dayName, gifts) {
		return $elm$core$String$concat(
			_List_fromArray(
				['On the ', dayName, ' day of Christmas my true love gave to me: ', gifts, '.']));
	});
var $author$project$TwelveDays$songLine = function (x) {
	return A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
			A2(
				...
				A2(
					...
					A2(
						$elm$core$Basics$composeL,
						$author$project$TwelveDays$lineLyrics(
							$author$project$TwelveDays$daySpellingByNumber(x)),
						$elm$core$String$join(', ')),
					$author$project$TwelveDays$concatLastGiftAnd),
				$elm$core$List$map($author$project$TwelveDays$christmasGiftByNumber)),
			$elm$core$List$reverse),
		$elm$core$List$range(0))(x);
};
var $author$project$TwelveDays$recite = F2(
	function (start, end) {
		var songDayNums = A2(
			$elm$core$List$range,
			A2($elm$core$Basics$max, 1, start) - 1,
			A2($elm$core$Basics$min, 12, end) - 1);
		return A2($elm$core$List$map, $author$project$TwelveDays$songLine, songDayNums);
	});
...
var $author$project$Test$Generated$Main1179306557$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/twelve-days/tests/Tests.elm']),
		processes: 8,
...
_Platform_export({'Test':{'Generated':{'Main1179306557':{'init':$author$project$Test$Generated$Main1179306557$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-7193.sock";
