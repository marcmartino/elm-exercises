			...
			if (list.b) {
				...
				if (pred(x)) {
					return A2(
						$elm$core$List$cons,
						x,
						A2($author$project$Strain$keep, pred, xs));
				} else {
					var $temp$pred = pred,
						$temp$list = xs;
					pred = $temp$pred;
...
var $author$project$Strain$discard = function (predicate) {
	return $author$project$Strain$keep(
...
var $author$project$Test$Generated$Main2262039191$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/strain/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 360383819938322
	},
...
_Platform_export({'Test':{'Generated':{'Main2262039191':{'init':$author$project$Test$Generated$Main2262039191$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-27265.sock";
