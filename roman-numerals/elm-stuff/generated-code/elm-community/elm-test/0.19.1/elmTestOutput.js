...
var $author$project$RomanNumerals$isCompleteableWithSubtraction = F3(
	function (numls, baseNum, target) {
		isCompleteableWithSubtraction:
		while (true) {
			if (numls.b) {
				var _v1 = numls.a;
				var romanVal = _v1.a;
				var otherNumls = numls.b;
				if (_Utils_eq(baseNum - romanVal, target)) {
					return true;
				} else {
					var $temp$numls = otherNumls,
						$temp$baseNum = baseNum,
						$temp$target = target;
					numls = $temp$numls;
					baseNum = $temp$baseNum;
					target = $temp$target;
					continue isCompleteableWithSubtraction;
				}
			} else {
				return false;
			}
...
var $author$project$RomanNumerals$narrowDownRomanNumerals = F2(
	function (numerals, number) {
		narrowDownRomanNumerals:
		while (true) {
			if (numerals.b) {
				if (!numerals.b.b) {
					var _v1 = numerals.a;
					var numlV = _v1.a;
					var numlL = _v1.b;
					return A2($elm$core$String$repeat, (number / numlV) | 0, numlL);
				} else {
					var _v2 = numerals.a;
					var numlV = _v2.a;
					var numlL = _v2.b;
					var _v3 = numerals.b;
					var _v4 = _v3.a;
					var lesserNumlV = _v4.a;
					var lesserNumlL = _v4.b;
					var otherNumls = _v3.b;
					if ((!A2($elm$core$Basics$modBy, numlV, number)) && (((number / numlV) | 0) <= 3)) {
						return A2($elm$core$String$repeat, (number / numlV) | 0, numlL);
					} else {
						if (!A2($elm$core$Basics$modBy, lesserNumlV, number)) {
							return A2($elm$core$String$repeat, (number / lesserNumlV) | 0, lesserNumlL);
						} else {
							if ((_Utils_cmp(number, numlV) < 0) && ((_Utils_cmp(number, lesserNumlV) > 0) && A3(
								$author$project$RomanNumerals$isCompleteableWithSubtraction,
								A2(
									$elm$core$List$cons,
									_Utils_Tuple2(lesserNumlV, lesserNumlL),
									otherNumls),
								numlV,
								number))) {
								return _Utils_ap(
									A2(
										$author$project$RomanNumerals$narrowDownRomanNumerals,
										A2(
											$elm$core$List$cons,
											_Utils_Tuple2(lesserNumlV, lesserNumlL),
											otherNumls),
								...
								if ((_Utils_cmp(number, numlV) < 0) && (_Utils_cmp(number, lesserNumlV) > 0)) {
									return _Utils_ap(
										lesserNumlL,
										A2($author$project$RomanNumerals$narrowDownRomanNumerals, otherNumls, number - lesserNumlV));
								} else {
									var $temp$numerals = A2(
										$elm$core$List$cons,
										_Utils_Tuple2(lesserNumlV, lesserNumlL),
										otherNumls),
										$temp$number = number;
									numerals = $temp$numerals;
									number = $temp$number;
									continue narrowDownRomanNumerals;
								}
							}
						}
					}
...
var $author$project$RomanNumerals$romanNumerals = _List_fromArray(
	[
...
var $author$project$RomanNumerals$digitToRomanNumeral = $author$project$RomanNumerals$narrowDownRomanNumerals($author$project$RomanNumerals$romanNumerals);
var $elm$core$Basics$pow = _Basics_pow;
var $author$project$RomanNumerals$toDigitValues = A2(
	$elm$core$Basics$composeR,
			...
			A2(
				...
				A2(
					...
					$elm$core$List$indexedMap(
						F2(
							function (i, digit) {
								return digit * A2($elm$core$Basics$pow, 10, i);
							})),
					$elm$core$List$filter(
						$elm$core$Basics$neq(0)))))));
var $author$project$RomanNumerals$toRoman = A2(
	$elm$core$Basics$composeR,
	$author$project$RomanNumerals$toDigitValues,
	A2(
		$elm$core$Basics$composeR,
		$elm$core$List$map($author$project$RomanNumerals$digitToRomanNumeral),
		...
		[
			...
			function (_v0) {
				return A2(
					...
					'M',
					$author$project$RomanNumerals$toRoman(1000));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'900',
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'CM',
					$author$project$RomanNumerals$toRoman(900));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'1900',
			function (_v2) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'MCM',
					$author$project$RomanNumerals$toRoman(1900));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'1',
			function (_v3) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'I',
					$author$project$RomanNumerals$toRoman(1));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'2',
			function (_v4) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'II',
					$author$project$RomanNumerals$toRoman(2));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'3',
			function (_v5) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'III',
					$author$project$RomanNumerals$toRoman(3));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'4',
			function (_v6) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'IV',
					$author$project$RomanNumerals$toRoman(4));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'5',
			function (_v7) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'V',
					$author$project$RomanNumerals$toRoman(5));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'6',
			function (_v8) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'VI',
					$author$project$RomanNumerals$toRoman(6));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'8',
			function (_v9) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'VIII',
					$author$project$RomanNumerals$toRoman(8));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'9',
			function (_v10) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'IX',
					$author$project$RomanNumerals$toRoman(9));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'20',
			function (_v11) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'XX',
					$author$project$RomanNumerals$toRoman(20));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'27',
			function (_v12) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'XXVII',
					$author$project$RomanNumerals$toRoman(27));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'48',
			function (_v13) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'XLVIII',
					$author$project$RomanNumerals$toRoman(48));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'59',
			function (_v14) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'LIX',
					$author$project$RomanNumerals$toRoman(59));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'93',
			function (_v15) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'XCIII',
					$author$project$RomanNumerals$toRoman(93));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'141',
			function (_v16) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'CXLI',
					$author$project$RomanNumerals$toRoman(141));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'163',
			function (_v17) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'CLXIII',
					$author$project$RomanNumerals$toRoman(163));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'402',
			function (_v18) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'CDII',
					$author$project$RomanNumerals$toRoman(402));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'575',
			function (_v19) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'DLXXV',
					$author$project$RomanNumerals$toRoman(575));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'911',
			function (_v20) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'CMXI',
					$author$project$RomanNumerals$toRoman(911));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'1024',
			function (_v21) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'MXXIV',
					$author$project$RomanNumerals$toRoman(1024));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'3000',
			function (_v22) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'MMM',
					$author$project$RomanNumerals$toRoman(3000));
			})
		]));
var $author$project$Test$Generated$Main1713833237$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/roman-numerals/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 265588916041671
	},
...
_Platform_export({'Test':{'Generated':{'Main1713833237':{'init':$author$project$Test$Generated$Main1713833237$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-21666.sock";
