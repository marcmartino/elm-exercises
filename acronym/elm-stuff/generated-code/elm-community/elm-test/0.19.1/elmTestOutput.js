...
var $author$project$Acronym$abbreviate = A2(
	$elm$core$Basics$composeR,
			...
			$elm$core$List$map(
				A2(
					...
					A2(
						...
						$elm$core$Maybe$withDefault(
							_Utils_chr(' '))))),
			A2($elm$core$Basics$composeR, $elm$core$String$fromList, $elm$core$String$toUpper))));
...
var $author$project$Test$Generated$Main2248352266$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/acronym/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 338622005364950
	},
...
_Platform_export({'Test':{'Generated':{'Main2248352266':{'init':$author$project$Test$Generated$Main2248352266$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-11894.sock";
