...
var $author$project$AllYourBase$countDigits = F3(
	function (base, placeNum, num) {
		return (placeNum < 0) ? _List_Nil : A2(
			$elm$core$List$cons,
			(num / A2($elm$core$Basics$pow, base, placeNum)) | 0,
			A3(
				$author$project$AllYourBase$countDigits,
				base,
				placeNum - 1,
				A2(
					$elm$core$Basics$modBy,
					A2($elm$core$Basics$pow, base, placeNum),
					num)));
	});
var $author$project$AllYourBase$removeLeadingZeros = function (list) {
	removeLeadingZeros:
	while (true) {
		if (list.b && (!list.a)) {
			var xs = list.b;
...
var $author$project$AllYourBase$fromDecimal = F2(
	function (base, num) {
		var newDigitsLen = $elm$core$Basics$round(
			A2($elm$core$Basics$logBase, 10, num) / A2($elm$core$Basics$logBase, 10, base));
		return $author$project$AllYourBase$removeLeadingZeros(
			A3($author$project$AllYourBase$countDigits, base, newDigitsLen, num));
	});
var $elm$core$List$sum = function (numbers) {
	return A3($elm$core$List$foldl, $elm$core$Basics$add, 0, numbers);
};
var $author$project$AllYourBase$toDecimal = function (base) {
	return A2(
		$elm$core$Basics$composeR,
		$elm$core$List$reverse,
		A2(
			...
			$elm$core$List$indexedMap(
				F2(
					function (place, digit) {
						return digit * A2($elm$core$Basics$pow, base, place);
					})),
			$elm$core$List$sum));
};
...
var $author$project$AllYourBase$validInputs = F3(
	function (startBase, digits, endBase) {
		var someNonzero = $elm$core$List$any(
			$elm$core$Basics$le(1));
		var onlyPositiveDigits = $elm$core$List$all(
			$elm$core$Basics$le(0));
		var allDigitsWinthinBase = $elm$core$List$all(
			$elm$core$Basics$gt(startBase));
		return ((startBase > 0) && ((endBase > 0) && (($elm$core$List$length(digits) > 0) && (onlyPositiveDigits(digits) && (someNonzero(digits) && allDigitsWinthinBase(digits)))))) ? $elm$core$Maybe$Just(_Utils_Tuple0) : $elm$core$Maybe$Nothing;
	});
var $author$project$AllYourBase$rebase = F3(
	function (inBase, digits, outBase) {
		return A2(
			$elm$core$Maybe$map,
			$author$project$AllYourBase$fromDecimal(outBase),
			A2(
				$elm$core$Maybe$map,
				function (_v0) {
					return A2($author$project$AllYourBase$toDecimal, inBase, digits);
				},
				A3($author$project$AllYourBase$validInputs, inBase, digits, outBase)));
	});
...
var $author$project$Test$Generated$Main3605677470$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/all-your-base/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 238898048039742
	},
...
_Platform_export({'Test':{'Generated':{'Main3605677470':{'init':$author$project$Test$Generated$Main3605677470$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-14448.sock";
