...
var $author$project$Wordy$Addition = {$: 'Addition'};
var $author$project$Wordy$Division = {$: 'Division'};
var $author$project$Wordy$Exponent = {$: 'Exponent'};
var $author$project$Wordy$Multiplication = {$: 'Multiplication'};
var $author$project$Wordy$Subtraction = {$: 'Subtraction'};
var $elm$core$Basics$pow = _Basics_pow;
var $author$project$Wordy$Num = function (a) {
	return {$: 'Num', a: a};
};
var $author$project$Wordy$Statement = function (a) {
	return {$: 'Statement', a: a};
};
var $author$project$Wordy$simplifyStatement = F3(
	function (opPred, resolveArithmetic, alg) {
		simplifyStatement:
		while (true) {
			var opMatches = opPred(alg.operation);
			var _v0 = alg.y;
			if (_v0.$ === 'Num') {
				var yNum = _v0.a;
				return opMatches ? $author$project$Wordy$Num(
					A3(resolveArithmetic, alg.x, alg.operation, yNum)) : $author$project$Wordy$Statement(alg);
			} else {
				var yStatement = _v0.a;
				if (opMatches) {
					var $temp$opPred = opPred,
						$temp$resolveArithmetic = resolveArithmetic,
						$temp$alg = _Utils_update(
						yStatement,
						{
							x: A3(resolveArithmetic, alg.x, alg.operation, yStatement.x)
						});
					opPred = $temp$opPred;
					resolveArithmetic = $temp$resolveArithmetic;
					alg = $temp$alg;
					continue simplifyStatement;
				} else {
					return $author$project$Wordy$Statement(
						_Utils_update(
							alg,
							{
								y: A3($author$project$Wordy$simplifyStatement, opPred, resolveArithmetic, yStatement)
							}));
				}
			}
		}
	});
var $author$project$Wordy$operatorSimplifiers = _List_fromArray(
	[
		A2(
		$author$project$Wordy$simplifyStatement,
		function (op) {
			return _Utils_eq(op, $author$project$Wordy$Exponent);
		},
		F3(
			function (x, _v0, y) {
		...
		$author$project$Wordy$simplifyStatement,
		function (op) {
			return _Utils_eq(op, $author$project$Wordy$Multiplication) || _Utils_eq(op, $author$project$Wordy$Division);
		},
		F3(
			function (x, op, y) {
				switch (op.$) {
		...
		$author$project$Wordy$simplifyStatement,
		function (op) {
			return _Utils_eq(op, $author$project$Wordy$Addition) || _Utils_eq(op, $author$project$Wordy$Subtraction);
		},
		F3(
			function (x, op, y) {
				switch (op.$) {
...
var $author$project$Wordy$simplify = F2(
	function (simps, alg) {
		simplify:
		while (true) {
			if (!simps.b) {
...
var $author$project$Wordy$AlgebraicStatement = F3(
...
var $author$project$Wordy$numParser = $elm$parser$Parser$oneOf(
	_List_fromArray(
		[
			A2(
...
var $author$project$Wordy$operationParser = $elm$parser$Parser$oneOf(
	_List_fromArray(
		[
			A2(
			$elm$parser$Parser$map,
			function (_v0) {
				return $author$project$Wordy$Addition;
			},
			$elm$parser$Parser$keyword('plus')),
			A2(
			$elm$parser$Parser$map,
			function (_v1) {
				return $author$project$Wordy$Addition;
			...
			$elm$parser$Parser$map,
			function (_v2) {
				return $author$project$Wordy$Subtraction;
			},
			$elm$parser$Parser$keyword('minus')),
			A2(
			$elm$parser$Parser$map,
			function (_v3) {
				return $author$project$Wordy$Subtraction;
			...
			$elm$parser$Parser$map,
			function (_v4) {
				return $author$project$Wordy$Multiplication;
			},
			$elm$parser$Parser$keyword('times')),
			A2(
			$elm$parser$Parser$map,
			function (_v5) {
				return $author$project$Wordy$Multiplication;
			...
			$elm$parser$Parser$keyword('multiplied by')),
			A2(
			$elm$parser$Parser$map,
			function (_v7) {
				return $author$project$Wordy$Division;
			},
			$elm$parser$Parser$keyword('divided by')),
			A2(
			$elm$parser$Parser$map,
			function (_v8) {
				return $author$project$Wordy$Division;
...
var $author$project$Wordy$parseSubsequentValues = function (x) {
	return $elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				...
				$elm$parser$Parser$map,
				function (_v0) {
					return $author$project$Wordy$Num(x);
				},
				$elm$parser$Parser$symbol('?')),
				A2(
				$elm$parser$Parser$keeper,
					...
					A2(
						...
						$elm$parser$Parser$succeed(
							F2(
								function (op, y) {
									return $author$project$Wordy$Statement(
										A3($author$project$Wordy$AlgebraicStatement, x, op, y));
								})),
						$elm$parser$Parser$spaces),
					A2($elm$parser$Parser$ignorer, $author$project$Wordy$operationParser, $elm$parser$Parser$spaces)),
				$elm$parser$Parser$lazy(
					function (_v1) {
						return $author$project$Wordy$cyclic$naryParser();
					}))
			]));
};
function $author$project$Wordy$cyclic$naryParser() {
	return A2($elm$parser$Parser$andThen, $author$project$Wordy$parseSubsequentValues, $author$project$Wordy$numParser);
}
try {
	var $author$project$Wordy$naryParser = $author$project$Wordy$cyclic$naryParser();
	$author$project$Wordy$cyclic$naryParser = function () {
		return $author$project$Wordy$naryParser;
	};
} catch ($) {
	throw 'Some top-level definitions from `Wordy` are causing infinite recursion:\n\n  ┌─────┐\n  │    naryParser\n  │     ↓\n  │    parseSubsequentValues\n  └─────┘\n\nThese errors are very tricky, so read https://elm-lang.org/0.19.1/bad-recursion to learn how to fix it!';}
var $author$project$Wordy$statementParser = A2(
	$elm$parser$Parser$keeper,
	A2(
		$elm$parser$Parser$ignorer,
		A2(
			...
			A2(
				...
				A2(
					...
					$elm$parser$Parser$keyword('What')),
				$elm$parser$Parser$spaces),
			$elm$parser$Parser$keyword('is')),
		$elm$parser$Parser$spaces),
	$author$project$Wordy$naryParser);
var $author$project$Wordy$answer = function (problem) {
	var _v0 = A2($elm$parser$Parser$run, $author$project$Wordy$statementParser, problem);
	if (_v0.$ === 'Ok') {
		if (_v0.a.$ === 'Statement') {
			var stmt = _v0.a.a;
			return A2($author$project$Wordy$simplify, $author$project$Wordy$operatorSimplifiers, stmt);
		} else {
			var num = _v0.a.a;
		...
		[
			...
			function (_v0) {
				return A2(
					...
					$author$project$Wordy$answer('What is 5?'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'addition',
			function (_v1) {
				return A2(
					...
					$author$project$Wordy$answer('What is 1 plus 1?'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'more addition',
			function (_v2) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Just(55),
					$author$project$Wordy$answer('What is 53 plus 2?'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v3) {
				return A2(
					...
					$author$project$Wordy$answer('What is -1 plus -10?'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'large addition',
			function (_v4) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Just(45801),
					$author$project$Wordy$answer('What is 123 plus 45678?'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'subtraction',
			function (_v5) {
				return A2(
					...
					$author$project$Wordy$answer('What is 4 minus -12?'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'multiplication',
			function (_v6) {
				return A2(
					...
					$author$project$Wordy$answer('What is -3 multiplied by 25?'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'division',
			function (_v7) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Just(-11),
					$author$project$Wordy$answer('What is 33 divided by -3?'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'multiple additions',
			function (_v8) {
				return A2(
					...
					$author$project$Wordy$answer('What is 1 plus 12 plus 3 plus 4?'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v9) {
				return A2(
					...
					$author$project$Wordy$answer('What is 1 plus 5 minus -2?'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v10) {
				return A2(
					...
					$author$project$Wordy$answer('What is 20 minus 4 minus 13?'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v11) {
				return A2(
					...
					$author$project$Wordy$answer('What is 17 minus 6 plus 3?'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v12) {
				return A2(
					...
					$author$project$Wordy$answer('What is 2 multiplied by -2 multiplied by 3?'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v13) {
				return A2(
					...
					$author$project$Wordy$answer('What is -3 plus 7 multiplied by -2?'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'addition and multiplication with symbols',
			function (_v14) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Just(-17),
					$author$project$Wordy$answer('What is -3 + 7 * -2?'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'multiple division',
			function (_v15) {
				return A2(
					...
					$author$project$Wordy$answer('What is -12 divided by 2?'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'unknown operation',
			function (_v16) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Nothing,
					$author$project$Wordy$answer('What is 52 cubed?'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'Non math question',
			function (_v17) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Nothing,
					$author$project$Wordy$answer('Who is the President of the United States?'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v18) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Nothing,
					$author$project$Wordy$answer('What is 1 plus?'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v19) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Nothing,
					$author$project$Wordy$answer('What is?'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v20) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Nothing,
					$author$project$Wordy$answer('What is 1 plus plus 2?'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v21) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Nothing,
					$author$project$Wordy$answer('What is 1 plus 2 1?'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v22) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Nothing,
					$author$project$Wordy$answer('What is 1 2 plus?'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v23) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Nothing,
					$author$project$Wordy$answer('What is plus 1 2?'));
			})
		]));
var $author$project$Test$Generated$Main2014954114$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/wordy/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 358399452162569
	},
...
_Platform_export({'Test':{'Generated':{'Main2014954114':{'init':$author$project$Test$Generated$Main2014954114$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-8102.sock";
