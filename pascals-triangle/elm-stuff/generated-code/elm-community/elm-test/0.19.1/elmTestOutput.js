...
var $author$project$Triangle$genNextRowRec = function (prevRow) {
	if (prevRow.b && prevRow.b.b) {
		var fst = prevRow.a;
		var _v1 = prevRow.b;
		var scnd = _v1.a;
		var rest = _v1.b;
		return A2(
			$elm$core$List$cons,
			fst + scnd,
			$author$project$Triangle$genNextRowRec(
				A2($elm$core$List$cons, scnd, rest)));
	} else {
		return _List_Nil;
	}
};
var $author$project$Triangle$genNextRow = function (prev) {
	return $author$project$Triangle$genNextRowRec(
		A2(
			$elm$core$List$cons,
			0,
			_Utils_ap(
...
var $author$project$Triangle$row = F2(
	function (rowNum, prevRows) {
		var _v0 = _Utils_Tuple2(rowNum, prevRows);
		_v0$0:
		while (true) {
			_v0$1:
			while (true) {
				if (!_v0.b.b) {
					...
					switch (_v0.a) {
						...
						default:
							...
							return A2(
								$elm$core$List$cons,
								$author$project$Triangle$genNextRow(prevRow),
								A2($elm$core$List$cons, prevRow, otherRows));
					}
				}
			}
			return _List_fromArray(
...
var $author$project$Triangle$rows = function (n) {
	return $elm$core$List$reverse(
		A3(
			$elm$core$List$foldl,
			$author$project$Triangle$row,
			_List_Nil,
			A2(
				$elm$core$List$range,
				0,
...
var $author$project$Test$Generated$Main3127179419$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/pascals-triangle/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 206452897043901
	},
...
_Platform_export({'Test':{'Generated':{'Main3127179419':{'init':$author$project$Test$Generated$Main3127179419$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-9749.sock";
