...
var $author$project$Hamming$countDiffs = F2(
	function (compTupl, differenceCount) {
		var b = compTupl.b;
		var a = compTupl.a;
		return (!_Utils_eq(a, b)) ? (differenceCount + 1) : differenceCount;
	});
var $author$project$Hamming$toListOfTuples = function (tup) {
	if (!_Utils_eq(
		$elm$core$List$length(tup.a),
		$elm$core$List$length(tup.b))) {
		return $elm$core$Maybe$Nothing;
	} else {
		if (!tup.a.b) {
			...
			if (!tup.b.b) {
				...
				return A2(
					...
					$author$project$Hamming$toListOfTuples(
						_Utils_Tuple2(xs, ys)));
			}
		}
	}
...
var $author$project$Hamming$distance = F2(
	function (left, right) {
		var _v0 = $author$project$Hamming$toListOfTuples(
			A2(
				$elm$core$Tuple$pair,
				A2($elm$core$String$split, '', left),
				A2($elm$core$String$split, '', right)));
		if (_v0.$ === 'Nothing') {
			return $elm$core$Result$Err('left and right strands must be of equal length');
		} else {
			var cells = _v0.a;
			return $elm$core$Result$Ok(
				A3($elm$core$List$foldl, $author$project$Hamming$countDiffs, 0, cells));
		}
	});
		...
		[
			...
			function (_v12) {
				return A2(
					...
					A2($author$project$Hamming$distance, 'AATGG', 'AAA'));
			}),
			A2(
			$elm_explorations$test$Test$test,
...
var $author$project$Test$Generated$Main2864138596$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/hamming/tests/Tests.elm']),
		processes: 8,
...
_Platform_export({'Test':{'Generated':{'Main2864138596':{'init':$author$project$Test$Generated$Main2864138596$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-18156.sock";
