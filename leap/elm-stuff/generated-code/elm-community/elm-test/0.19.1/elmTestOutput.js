...
var $author$project$Leap$divBy = function (div) {
	return A2(
		$elm$core$Basics$composeL,
		$elm$core$Basics$eq(0),
		$elm$core$Basics$modBy(div));
};
var $author$project$Leap$isLeapYear = function (year) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Leap$divBy(4),
				function (x) {
				return (!A2($author$project$Leap$divBy, 100, x)) || A2($author$project$Leap$divBy, 400, x);
			}
			]));
};
...
var $author$project$Test$Generated$Main1842501332$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/leap/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 236265813179997
	},
...
_Platform_export({'Test':{'Generated':{'Main1842501332':{'init':$author$project$Test$Generated$Main1842501332$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-28768.sock";
