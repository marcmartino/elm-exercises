...
var $author$project$PhoneNumber$isCorrectLength = function (len) {
...
var $author$project$PhoneNumber$isValidNumber = function () {
	var regex = A2(
		$elm$core$Maybe$withDefault,
		$elm$regex$Regex$never,
		$elm$regex$Regex$fromString('[2-9]\\d{2}[2-9]\\d{6}'));
	return A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
...
var $author$project$PhoneNumber$maybe = F2(
	function (pred, val) {
		return pred(val) ? $elm$core$Maybe$Just(val) : $elm$core$Maybe$Nothing;
	});
var $elm$regex$Regex$replace = _Regex_replaceAtMost(_Regex_infinity);
var $author$project$PhoneNumber$onlyNumbers = function () {
	var regex = A2(
		$elm$core$Maybe$withDefault,
		$elm$regex$Regex$never,
...
var $author$project$PhoneNumber$removeOne = function (num) {
	var _v0 = _Utils_Tuple2(
		$elm$core$String$toList(num),
	...
	while (true) {
		switch (_v0.b) {
			...
			case 11:
				if (_v0.a.b && ('1' === _v0.a.a.valueOf())) {
					var _v1 = _v0.a;
					var restNum = _v1.b;
					return $elm$core$Maybe$Just(
						$elm$core$String$fromList(restNum));
				} else {
					break _v0$2;
				}
			default:
...
var $author$project$PhoneNumber$getNumber = A2(
	$elm$core$Basics$composeL,
	A2(
		$elm$core$Basics$composeL,
		A2(
			...
			$elm$core$Maybe$andThen(
				$author$project$PhoneNumber$maybe($author$project$PhoneNumber$isValidNumber)),
			$elm$core$Maybe$andThen($author$project$PhoneNumber$removeOne)),
		$author$project$PhoneNumber$maybe(
			A2($elm$core$Basics$composeL, $author$project$PhoneNumber$isCorrectLength, $elm$core$String$length))),
	$author$project$PhoneNumber$onlyNumbers);
...
var $author$project$Test$Generated$Main528659460$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/phone-number/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 208810107132838
	},
...
_Platform_export({'Test':{'Generated':{'Main528659460':{'init':$author$project$Test$Generated$Main528659460$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-21222.sock";
