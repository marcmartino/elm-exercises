...
var $author$project$Raindrops$defaultList = F2(
...
var $author$project$Raindrops$divisibleBy = function (divisor) {
	return A2(
		$elm$core$Basics$composeR,
		$elm$core$Basics$modBy(divisor),
		$elm$core$Basics$eq(0));
};
var $author$project$Raindrops$dropTests = _List_fromArray(
	[
		_Utils_Tuple2(
		$author$project$Raindrops$divisibleBy(3),
		'Pling'),
		_Utils_Tuple2(
		$author$project$Raindrops$divisibleBy(5),
		'Plang'),
		_Utils_Tuple2(
		$author$project$Raindrops$divisibleBy(7),
		'Plong')
	]);
var $author$project$Raindrops$filterNothing = function (list) {
	filterNothing:
	while (true) {
		if (list.b) {
			if (list.a.$ === 'Just') {
				...
				return A2(
					$elm$core$List$cons,
					x,
					$author$project$Raindrops$filterNothing(xs));
			} else {
				var _v1 = list.a;
				var xs = list.b;
				var $temp$list = xs;
...
var $author$project$Raindrops$testDrop = F2(
	function (n, dropCondition) {
		return A2($elm$core$Tuple$first, dropCondition, n) ? $elm$core$Maybe$Just(dropCondition.b) : $elm$core$Maybe$Nothing;
	});
var $author$project$Raindrops$raindrops = function (number) {
	return A2(
		...
		'',
		A2(
			$author$project$Raindrops$defaultList,
			_List_fromArray(
				[
					$elm$core$String$fromInt(number)
				]),
			$author$project$Raindrops$filterNothing(
				A2(
					$elm$core$List$map,
					$author$project$Raindrops$testDrop(number),
					$author$project$Raindrops$dropTests))));
};
...
var $author$project$Test$Generated$Main3426232034$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/raindrops/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 237634264724622
	},
...
_Platform_export({'Test':{'Generated':{'Main3426232034':{'init':$author$project$Test$Generated$Main3426232034$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-26338.sock";
