...
var $author$project$Isogram$charToSet = function (c) {
	return $elm$core$Maybe$andThen(
		function (chars) {
			return A2($elm$core$Set$member, c, chars) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(
				A2($elm$core$Set$insert, c, chars));
		});
};
var $author$project$Isogram$isJust = function (m) {
	if (m.$ === 'Just') {
		return true;
	} else {
		return false;
...
var $author$project$Isogram$sanitizeNonLetters = function () {
	var regex = A2(
		$elm$core$Maybe$withDefault,
...
var $author$project$Isogram$isIsogram = A2(
	$elm$core$Basics$composeR,
	$elm$core$String$toLower,
	A2(
		$elm$core$Basics$composeR,
		$author$project$Isogram$sanitizeNonLetters,
		A2(
			$elm$core$Basics$composeR,
			...
			A2(
				...
				A2(
					$elm$core$List$foldl,
					$author$project$Isogram$charToSet,
					$elm$core$Maybe$Just($elm$core$Set$empty)),
				$author$project$Isogram$isJust))));
...
var $author$project$Test$Generated$Main2894642717$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/isogram/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 226746783879593
	},
...
_Platform_export({'Test':{'Generated':{'Main2894642717':{'init':$author$project$Test$Generated$Main2894642717$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-31045.sock";
