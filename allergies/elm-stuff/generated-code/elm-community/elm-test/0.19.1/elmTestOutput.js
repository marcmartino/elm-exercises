...
var $author$project$Allergies$alls = _List_fromArray(
...
var $author$project$Allergies$allergensList = A2(
	$elm$core$List$map,
	function (_v0) {
		var i = _v0.a;
		var all = _v0.b;
	...
	$elm$core$List$reverse(
		A2($elm$core$List$indexedMap, $elm$core$Tuple$pair, $author$project$Allergies$alls)));
var $author$project$Allergies$findAllergen = F2(
	function (list, allergy) {
		findAllergen:
		while (true) {
			if (!list.b) {
				return 0;
				...
				var val = _v1.b;
				var xs = list.b;
				if (_Utils_eq(all, allergy)) {
					return val;
				} else {
					var $temp$list = xs,
						$temp$allergy = allergy;
					list = $temp$list;
					allergy = $temp$allergy;
					continue findAllergen;
				}
			}
		}
	});
var $author$project$Allergies$allergensByName = $author$project$Allergies$findAllergen($author$project$Allergies$allergensList);
var $author$project$Allergies$checkAllergyScore = function (testScore) {
	return A2(
		$elm$core$Basics$composeR,
		$elm$core$Bitwise$and(testScore),
		$elm$core$Basics$neq(0));
};
var $author$project$Allergies$isAllergicTo = F2(
	function (allergy, score) {
		return A2(
			$author$project$Allergies$checkAllergyScore,
			score,
			$author$project$Allergies$allergensByName(allergy));
	});
...
var $author$project$Allergies$toListRec = F2(
	function (allList, score) {
		toListRec:
		while (true) {
			if (!allList.b) {
				return _List_Nil;
				...
				var _v1 = allList.a;
				var allergen = _v1.a;
				var allergenValue = _v1.b;
				var otherAlls = allList.b;
				if (A2($author$project$Allergies$checkAllergyScore, score, allergenValue)) {
					return A2(
						$elm$core$List$cons,
						allergen,
						A2($author$project$Allergies$toListRec, otherAlls, score));
				} else {
					var $temp$allList = otherAlls,
						$temp$score = score;
					allList = $temp$allList;
					score = $temp$score;
					continue toListRec;
				}
			}
...
var $author$project$Allergies$toList = function (score) {
	return A2($author$project$Allergies$toListRec, $author$project$Allergies$allergensList, score);
};
		...
		[
						...
						[
							...
							function (_v4) {
								return A2(
									$elm_explorations$test$Expect$equal,
									true,
									A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Eggs, 5));
							}),
							A2(
							$elm_explorations$test$Test$test,
							'shellfish',
							function (_v5) {
								return A2(
									$elm_explorations$test$Expect$equal,
									true,
									A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Shellfish, 5));
							}),
							A2(
							$elm_explorations$test$Test$test,
							'strawberries',
							function (_v6) {
								return A2(
									$elm_explorations$test$Expect$equal,
									false,
									A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Strawberries, 5));
							})
						]))
				])),
			A2(
			...
			_List_fromArray(
				[
					...
					A2(
					$elm_explorations$test$Test$test,
					'ignore all non allergen score parts',
					function (_v11) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$author$project$Tests$allergySort(
...
var $author$project$Test$Generated$Main2515301128$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/allergies/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 252523855719283
	},
...
_Platform_export({'Test':{'Generated':{'Main2515301128':{'init':$author$project$Test$Generated$Main2515301128$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-5145.sock";
