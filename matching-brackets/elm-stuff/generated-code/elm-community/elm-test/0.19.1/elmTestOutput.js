...
var $author$project$MatchingBrackets$Bracket = {$: 'Bracket'};
var $author$project$MatchingBrackets$Curly = {$: 'Curly'};
var $author$project$MatchingBrackets$Paren = {$: 'Paren'};
...
var $author$project$MatchingBrackets$bracketRemoveHead = function (item) {
	return $elm$core$Maybe$andThen(
		function (stack) {
			if (stack.b) {
				var x = stack.a;
				var xs = stack.b;
				return _Utils_eq(x, item) ? $elm$core$Maybe$Just(xs) : $elm$core$Maybe$Nothing;
			} else {
				return $elm$core$Maybe$Nothing;
			}
		});
};
var $author$project$MatchingBrackets$bracketStackCons = function (item) {
	return $elm$core$Maybe$map(
		function (xs) {
			return A2($elm$core$List$cons, item, xs);
		});
};
var $author$project$MatchingBrackets$checkBrackets = F2(
	function (_char, bkts) {
		switch (_char.valueOf()) {
			case '(':
				return A2($author$project$MatchingBrackets$bracketStackCons, $author$project$MatchingBrackets$Paren, bkts);
			case '[':
				return A2($author$project$MatchingBrackets$bracketStackCons, $author$project$MatchingBrackets$Bracket, bkts);
			case '{':
				return A2($author$project$MatchingBrackets$bracketStackCons, $author$project$MatchingBrackets$Curly, bkts);
			case ')':
				return A2($author$project$MatchingBrackets$bracketRemoveHead, $author$project$MatchingBrackets$Paren, bkts);
			case ']':
				return A2($author$project$MatchingBrackets$bracketRemoveHead, $author$project$MatchingBrackets$Bracket, bkts);
			case '}':
				return A2($author$project$MatchingBrackets$bracketRemoveHead, $author$project$MatchingBrackets$Curly, bkts);
			default:
				return $elm$core$Maybe$Nothing;
		}
	});
var $elm$core$String$foldl = _String_foldl;
var $author$project$MatchingBrackets$isEmpty = A2(
	$elm$core$Basics$composeL,
	$elm$core$Maybe$withDefault(false),
	$elm$core$Maybe$map($elm$core$List$isEmpty));
...
var $author$project$MatchingBrackets$sanitize = function (input) {
	return A2(
		$elm$core$Maybe$withDefault,
		'',
		A2(
...
var $author$project$MatchingBrackets$isPaired = A2(
	$elm$core$Basics$composeL,
	A2(
		$elm$core$Basics$composeL,
		$author$project$MatchingBrackets$isEmpty,
		A2(
			$elm$core$String$foldl,
			$author$project$MatchingBrackets$checkBrackets,
			$elm$core$Maybe$Just(_List_Nil))),
	$author$project$MatchingBrackets$sanitize);
...
var $author$project$Test$Generated$Main326980175$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/matching-brackets/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 267299990582222
	},
...
_Platform_export({'Test':{'Generated':{'Main326980175':{'init':$author$project$Test$Generated$Main326980175$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-22586.sock";
