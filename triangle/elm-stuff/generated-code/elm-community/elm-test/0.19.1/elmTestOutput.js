...
var $author$project$Triangle$validTriangleLengths = function (lens) {
	if ((lens.b && lens.b.b) && lens.b.b.b) {
		var x = lens.a;
		var _v1 = lens.b;
		var y = _v1.a;
		var _v2 = _v1.b;
		var z = _v2.a;
		return (_Utils_cmp(x + y, z) > -1) && ((_Utils_cmp(y + z, x) > -1) && (_Utils_cmp(x + z, y) > -1));
	} else {
		return false;
	}
};
...
var $author$project$Triangle$validator = F2(
	function (valTupl, xs) {
		return A2($elm$core$Tuple$first, valTupl, xs) ? $elm$core$Result$Ok(xs) : $elm$core$Result$Err(valTupl.b);
	});
var $author$project$Triangle$isValidTriangle = function (tri) {
	var someNonZero = _Utils_Tuple2(
		$elm$core$List$any(
			$elm$core$Basics$neq(0)),
		'Invalid lengths');
	var lengthEqualities = _Utils_Tuple2($author$project$Triangle$validTriangleLengths, 'Violates inequality');
	var allPositive = _Utils_Tuple2(
		$elm$core$List$all(
			$elm$core$Basics$le(0)),
		'Invalid lengths');
	var validations = A2(
		$elm$core$List$map,
		$author$project$Triangle$validator,
		_List_fromArray(
			[someNonZero, allPositive, lengthEqualities]));
	return A3(
		$elm$core$List$foldl,
		$elm$core$Result$andThen,
		$elm$core$Result$Ok(tri),
		validations);
};
...
var $author$project$Triangle$toTriple = function (lengths) {
	var _v0 = $elm$core$List$sort(lengths);
...
var $author$project$Triangle$isEqualateral = function (lens) {
	var a = lens.a;
	var b = lens.b;
	var c = lens.c;
	return _Utils_eq(a, b) && _Utils_eq(b, c);
};
var $author$project$Triangle$isIsosceles = function (lens) {
	var a = lens.a;
	var b = lens.b;
	var c = lens.c;
	return (_Utils_eq(a, b) || (_Utils_eq(b, c) || _Utils_eq(c, a))) && (!(_Utils_eq(a, b) && _Utils_eq(b, c)));
};
var $author$project$Triangle$triangleTypeAssignment = function (tri) {
	return $author$project$Triangle$isEqualateral(tri) ? $author$project$Triangle$Equilateral : ($author$project$Triangle$isIsosceles(tri) ? $author$project$Triangle$Isosceles : $author$project$Triangle$Scalene);
};
var $author$project$Triangle$triangleKind = F3(
	function (x, y, z) {
		return A2(
			$elm$core$Result$map,
			$author$project$Triangle$triangleTypeAssignment,
			A2(
				$elm$core$Result$map,
				$author$project$Triangle$toTriple,
				$author$project$Triangle$isValidTriangle(
					_List_fromArray(
						[x, y, z]))));
	});
...
var $author$project$Test$Generated$Main1782775702$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/triangle/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 289935239269950
	},
...
_Platform_export({'Test':{'Generated':{'Main1782775702':{'init':$author$project$Test$Generated$Main1782775702$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-21951.sock";
