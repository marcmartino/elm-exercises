...
import Expect
import RunLengthEncoding exposing (decode, encode, encodedToCounts)
...
tests =
    describe "RunLengthEncoding"
        ...
        , describe "encoded to counts"
            [ test "basic tally" <|
                \() ->
                    Expect.equal [ ( 'z', 3 ) ]
                        (encodedToCounts 0 [ '3', 'z' ])
            , test "complex tally" <|
                \() ->
                    Expect.equal [ ( ' ', 3 ), ( 'z', 1 ), ( 'j', 2 ), ( 'i', 1 ), ( 'r', 1 ) ]
                        (encodedToCounts 0 [ '3', ' ', 'z', '2', 'j', 'i', 'r' ])
            ]
        ]
