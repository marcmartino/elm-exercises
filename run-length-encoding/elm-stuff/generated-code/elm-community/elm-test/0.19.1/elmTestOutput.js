...
var $author$project$RunLengthEncoding$charToInt = A2(
	$elm$core$Basics$composeL,
	A2(
		$elm$core$Basics$composeL,
...
var $author$project$RunLengthEncoding$encodedToCounts = F2(
	function (pendingCount, chars) {
		encodedToCounts:
		while (true) {
			if (chars.b) {
				var c = chars.a;
				...
				if ($elm$core$Char$isDigit(c)) {
					var $temp$pendingCount = (pendingCount * 10) + $author$project$RunLengthEncoding$charToInt(c),
						$temp$chars = cs;
					pendingCount = $temp$pendingCount;
					chars = $temp$chars;
					continue encodedToCounts;
				} else {
					return A2(
						$elm$core$List$cons,
						_Utils_Tuple2(
							c,
							A2($elm$core$Basics$max, pendingCount, 1)),
						A2($author$project$RunLengthEncoding$encodedToCounts, 0, cs));
				}
			} else {
				return _List_Nil;
			}
...
var $author$project$RunLengthEncoding$expandCounts = function (count) {
	return A2(
		$elm$core$List$map,
		$elm$core$Basics$always(count.a),
		A2($elm$core$List$range, 1, count.b));
};
...
var $author$project$RunLengthEncoding$sanitize = function (regexStr) {
	var invalidChars = A2(
		$elm$core$Maybe$withDefault,
...
var $author$project$RunLengthEncoding$sanitizeBeforeDecoding = $author$project$RunLengthEncoding$sanitize('[^ 0-9A-z]');
var $author$project$RunLengthEncoding$decode = A2(
	$elm$core$Basics$composeL,
	A2(
		$elm$core$Basics$composeL,
		A2(
			...
			A2(
				...
				$elm$core$List$concatMap($author$project$RunLengthEncoding$expandCounts)),
			$author$project$RunLengthEncoding$encodedToCounts(0)),
		$elm$core$String$toList),
	$author$project$RunLengthEncoding$sanitizeBeforeDecoding);
var $author$project$RunLengthEncoding$combineCounts = function (count) {
	return $elm$core$Basics$append(
		_Utils_ap(
			function (c) {
				return (c === 1) ? '' : $elm$core$String$fromInt(c);
			}(count.b),
			$elm$core$String$fromChar(count.a)));
};
var $author$project$RunLengthEncoding$countDuplicates = F2(
	function (next, counts) {
		if (counts.b) {
			...
			var count = _v1.b;
			var xs = counts.b;
			return _Utils_eq(next, prev) ? A2(
				$elm$core$List$cons,
				_Utils_Tuple2(prev, count + 1),
				xs) : A2(
				$elm$core$List$cons,
				_Utils_Tuple2(next, 1),
				counts);
		} else {
			return _List_fromArray(
				[
...
var $author$project$RunLengthEncoding$sanitizeBeforeEncoding = $author$project$RunLengthEncoding$sanitize('[^ A-z]');
var $author$project$RunLengthEncoding$encode = A2(
	$elm$core$Basics$composeL,
	A2(
		$elm$core$Basics$composeL,
		A2($elm$core$List$foldl, $author$project$RunLengthEncoding$combineCounts, ''),
		A2($elm$core$String$foldl, $author$project$RunLengthEncoding$countDuplicates, _List_Nil)),
	$author$project$RunLengthEncoding$sanitizeBeforeEncoding);
				...
				[
					...
					function (_v0) {
						return A2(
							...
							'',
							$author$project$RunLengthEncoding$encode(''));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v1) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'XYZ',
							$author$project$RunLengthEncoding$encode('XYZ'));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v2) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'2A3B4C',
							$author$project$RunLengthEncoding$encode('AABBBCCCC'));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v3) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'12WB12W3B24WB',
							$author$project$RunLengthEncoding$encode('WWWWWWWWWWWWBWWWWWWWWWWWWBBBWWWWWWWWWWWWWWWWWWWWWWWWB'));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v4) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'2 hs2q q2w2 ',
							$author$project$RunLengthEncoding$encode('  hsqq qww  '));
					}),
					A2(
					$elm_explorations$test$Test$test,
				...
				[
					...
					function (_v6) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'',
							$author$project$RunLengthEncoding$decode(''));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v7) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'XYZ',
							$author$project$RunLengthEncoding$decode('XYZ'));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'string with no single characters',
					function (_v8) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'AABBBCCCC',
							$author$project$RunLengthEncoding$decode('2A3B4C'));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v9) {
						return A2(
							...
							$author$project$RunLengthEncoding$decode('12WB12W3B24WB'));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'multiple whitespace mixed in string',
					function (_v10) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'  hsqq qww  ',
							$author$project$RunLengthEncoding$decode('2 hs2q q2w2 '));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'lower case string',
					...
					function (_v12) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'WWWWWWWWWW',
							$author$project$RunLengthEncoding$decode('10W'));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
				...
				[
					...
					function (_v13) {
						return A2(
							...
							'zzz ZZ  zZ',
							$author$project$RunLengthEncoding$decode(
								$author$project$RunLengthEncoding$encode('zzz ZZ  zZ')));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
				...
				[
					...
					function (_v14) {
						return A2(
							...
							A2(
								$author$project$RunLengthEncoding$encodedToCounts,
								0,
								_List_fromArray(
									[
										_Utils_chr('3'),
...
var $author$project$Test$Generated$Main2256508665$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/run-length-encoding/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 251646297722681
	},
...
_Platform_export({'Test':{'Generated':{'Main2256508665':{'init':$author$project$Test$Generated$Main2256508665$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-25271.sock";
