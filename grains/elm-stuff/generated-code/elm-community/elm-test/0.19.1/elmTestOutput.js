...
var $author$project$Grains$validSquareNumber = function (num) {
	return ((num > 0) && (num <= 64)) ? $elm$core$Maybe$Just(num) : $elm$core$Maybe$Nothing;
};
var $author$project$Grains$square = A2(
	$elm$core$Basics$composeR,
	$author$project$Grains$validSquareNumber,
	$elm$core$Maybe$map(
		A2(
			$elm$core$Basics$composeR,
			$elm$core$Basics$add(-1),
			$elm$core$Basics$pow(2))));
var $author$project$Grains$mapAndFold = F3(
	function (map, fold, _default) {
		return A2(
			$elm$core$List$foldl,
			F2(
				function (x, accum) {
...
var $author$project$Grains$sumSquares = A2(
	$elm$core$Basics$composeR,
	$author$project$Grains$validSquareNumber,
	$elm$core$Maybe$map(
		A2(
			...
			A2(
				...
				A3(
					$author$project$Grains$mapAndFold,
					$elm$core$Basics$pow(2),
					$elm$core$Basics$add,
					0)))));
				...
				[
					...
					function (_v0) {
						return A2(
							...
							$author$project$Grains$sumSquares(4));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
...
var $author$project$Test$Generated$Main1041502134$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/grains/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 108678582474020
	},
...
_Platform_export({'Test':{'Generated':{'Main1041502134':{'init':$author$project$Test$Generated$Main1041502134$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-21383.sock";
