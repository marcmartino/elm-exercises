...
var $author$project$Bob$Nonsense = function (a) {
	return {$: 'Nonsense', a: a};
};
var $author$project$Bob$Question = function (a) {
	return {$: 'Question', a: a};
};
var $author$project$Bob$Silence = {$: 'Silence'};
var $author$project$Bob$Statement = function (a) {
	return {$: 'Statement', a: a};
};
var $elm$core$String$endsWith = _String_endsWith;
var $elm$core$String$length = _String_length;
var $author$project$Bob$getSentenceType = function (str) {
	var trimmed = $elm$core$String$trim(str);
	var statement = A2($elm$core$String$endsWith, '.', trimmed);
	var question = A2($elm$core$String$endsWith, '?', trimmed);
	return question ? $author$project$Bob$Question(trimmed) : (statement ? $author$project$Bob$Statement(trimmed) : ((!$elm$core$String$length(trimmed)) ? $author$project$Bob$Silence : $author$project$Bob$Nonsense(trimmed)));
};
...
var $author$project$Bob$isYelling = function (str) {
	var hasUppercaseLetters = $elm$regex$Regex$contains(
		A2(
			$elm$core$Maybe$withDefault,
			$elm$regex$Regex$never,
			$elm$regex$Regex$fromString('[A-Z]+')));
	return hasUppercaseLetters(str) && _Utils_eq(
		str,
		$elm$core$String$toUpper(str));
};
var $author$project$Bob$hey = function (remark) {
	var _v0 = _Utils_Tuple2(
		$author$project$Bob$getSentenceType(remark),
		$author$project$Bob$isYelling(remark));
	_v0$5:
	while (true) {
		switch (_v0.a.$) {
			case 'Question':
...
var $author$project$Test$Generated$Main3057566390$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/bob/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 227730792159929
	},
...
_Platform_export({'Test':{'Generated':{'Main3057566390':{'init':$author$project$Test$Generated$Main3057566390$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-17576.sock";
