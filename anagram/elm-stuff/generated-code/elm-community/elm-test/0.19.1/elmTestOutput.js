...
var $author$project$Anagram$sort = function (list) {
	if (list.b) {
		var x = list.a;
		var xs = list.b;
		var low = A2(
			$elm$core$List$filter,
			$elm$core$Basics$gt(x),
			xs);
		var high = A2(
			$elm$core$List$filter,
			$elm$core$Basics$le(x),
			xs);
		return _Utils_ap(
			$author$project$Anagram$sort(low),
			A2(
				$elm$core$List$cons,
				x,
				$author$project$Anagram$sort(high)));
	} else {
		return _List_Nil;
	}
};
var $author$project$Anagram$sortWord = A2(
	$elm$core$Basics$composeL,
	A2($elm$core$Basics$composeL, $elm$core$String$fromList, $author$project$Anagram$sort),
	$elm$core$String$toList);
var $elm$core$String$toLower = _String_toLower;
var $author$project$Anagram$detect = function (word) {
	var sortedWord = $author$project$Anagram$sortWord(
	...
	return A2(
		...
		$elm$core$List$filter(
			A2(
				...
				A2(
					$elm$core$Basics$composeL,
					$elm$core$Basics$eq(sortedWord),
					$author$project$Anagram$sortWord),
...
var $author$project$Test$Generated$Main3862304069$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marmar/exercism/elm/anagram/tests/Tests.elm']),
		processes: 8,
...
_Platform_export({'Test':{'Generated':{'Main3862304069':{'init':$author$project$Test$Generated$Main3862304069$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-1380.sock";
